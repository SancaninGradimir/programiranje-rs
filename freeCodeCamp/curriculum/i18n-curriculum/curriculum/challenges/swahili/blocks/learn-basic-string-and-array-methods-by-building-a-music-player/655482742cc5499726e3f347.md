...
U bloku sa `else`, kreiraj konstantu pod nazivom `currentSongIndex` i postavi vrednost `getCurrentSongIndex()`.

# --hints--

Не смете мењати функцију `playPreviousSong` која се налази и садржи у њему.
...
Izjava za `if` mora da sadrži blok `else`.
