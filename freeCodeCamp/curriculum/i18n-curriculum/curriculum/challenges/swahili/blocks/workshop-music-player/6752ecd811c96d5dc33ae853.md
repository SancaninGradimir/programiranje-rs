...
Da bi se osiguralo da se prikaz plejera ažurira svaki put kada počne da se reprodukovati nova pesma, pozovite funkciju `setPlayerDisplay()` unutar funkcije `playSong()`.

Sada bi trebalo da vidite naslov pesme i izvođača prikazane na ekranu.
