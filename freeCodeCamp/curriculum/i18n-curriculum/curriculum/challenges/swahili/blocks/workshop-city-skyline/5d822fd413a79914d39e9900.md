...
Zatim, promeni `#999` dva za `.bb2a` u `transparent`. Ovo će učiniti da levi i desni rubovi budu nevidljivi.
...
Trebalo bi da promeniš `border-right` ili koristiš `transparent`.
