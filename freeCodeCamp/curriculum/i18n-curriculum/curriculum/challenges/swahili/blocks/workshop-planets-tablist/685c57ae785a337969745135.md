...
Za poslednji korak, morate učiniti da je panel vidljiv kada se klikne na njegovu pridruženu karticu. To možete učiniti postavljanjem svojstva `hidden` na `panel` na `false`.

Kliknite na bilo koju od kartica i trebalo bi da vidite prikazan sadržaj odgovarajućeg panela.
