...
Indentujte vaš postojeći `for` petlja za jedan nivo kako bi se izvršila kada katalog sadrži filmove. Zatim, zamenite `self.items` sa `movies` da biste iterirali samo kroz filmove.
