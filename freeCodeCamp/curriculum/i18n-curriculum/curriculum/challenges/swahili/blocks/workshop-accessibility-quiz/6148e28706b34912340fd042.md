...
Stavite sav tekst unutar elementa ``address`` centrirano vertikalno, i dodajte interni razmak.
...
Moraš mu dati `address` `padding-top` od najmanje `1px`.
...
Trebalo bi mu dati `address` `padding-bottom` od najmanje `1px`.
...
Trebalo bi mu dati `address` `padding-left` od najmanje `1px`.
