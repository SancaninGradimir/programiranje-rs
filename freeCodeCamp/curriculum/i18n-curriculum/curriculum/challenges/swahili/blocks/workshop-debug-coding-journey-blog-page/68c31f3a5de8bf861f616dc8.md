...
Trenutno, sekcija `footer` ima zaglavlje sekcije `h3`. Ali trebalo bi da ima zaglavlje sekcije `h2` kako bi se održao ispravan redosled zaglavlja sekcija.

Zameni `h3` sa `h2`.

# --hints--

Vaš element od `footer` bi trebalo da ima element `h2` umesto elementa `h3`.
