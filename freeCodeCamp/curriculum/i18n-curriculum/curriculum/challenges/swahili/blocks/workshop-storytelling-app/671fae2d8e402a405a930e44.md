...
Dodaj slušaoca događaja za `click` za `scaryStoryBtn` i prosledite funkciju `displayStory`. Zatim, kliknite na dugme i vidite rezultate u konzoli.

# --hints--

Trebalo bi dodati *event listener* za `click` za `scaryStoryBtn`, koristeći funkciju `displayStory`.
