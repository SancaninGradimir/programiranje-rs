...
Zatim, kreiraj funkciju nazvanu `getBookInformation` sa jednim parametrom. Ovaj parametar će predstavljati niz knjiga kada se funkcija pozove. Možete nazvati parametar `catalog`.
