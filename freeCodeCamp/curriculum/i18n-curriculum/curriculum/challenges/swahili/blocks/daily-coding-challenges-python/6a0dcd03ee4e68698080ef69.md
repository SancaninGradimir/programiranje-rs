...
Dat je dvodimenzionalni niz u kome svaki podniz sadrži (ovim redom) naziv ideje, optimističnu procenu, realnu procenu i pesimističnu procenu (u danima). Vrati niz naziva ideja sortiran prema očekivanom vremenu završetka, od najkraćeg ka najdužem.

Izračunaj očekivano vreme završetka za svaku ideju koristeći sledeću formulu:
