...
Trebalo bi da imate metod `forEach` vezan za parametar `elements`.
...
Vaš `forEach` metod bi trebalo da primi callback parametar.
...
Unutar forEach metode, trebalo bi dodati skriveni class koristeći `classList.add` metodu.
