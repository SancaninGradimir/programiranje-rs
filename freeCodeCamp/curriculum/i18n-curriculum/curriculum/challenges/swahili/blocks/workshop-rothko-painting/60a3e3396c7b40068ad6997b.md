...
Sada postavi `height` za `.one` da bude 150 piksela.

# --hints--

Trebalo bi da postaviš vrednost za `height` na `150px`.
...
Vaše polje za `.one` treba da ima vrednost od `height` od `150px`.
