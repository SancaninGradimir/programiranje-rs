...
Sada, trebalo bi da dodate neki padding kontejneru. Postavite `padding` na `10px 20px`. Na ovaj način, postavljate padding od `10px` na vrhu i dnu, a `20px` sa leve i desne strane.
