...
Vratite se na stilizovanje stranice. Izaberite elemente liste unutar navigacionog panela, i dodelite im sledeće stilove:
...
Trebalo bi da im date elemente `li` `padding` od `0.2rem`.
...
Trebali biste im dati elemente `li` `display` iz `block`.
