...
U prethodnom koraku, dobili ste središte tačku. Možete je koristiti da podelite `array` na dva dela i dodelite svaki deo novim varijablama.

Koristite sintaksu za sekcije (slice syntax) da izvučete levu polovinu `array` i dodelite je varijabli pod nazivom `left_part`.
