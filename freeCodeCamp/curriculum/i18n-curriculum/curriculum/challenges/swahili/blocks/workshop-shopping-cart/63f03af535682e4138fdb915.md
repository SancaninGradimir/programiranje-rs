...
Postavi `textContent` za komponente od `totalNumberOfItems`, `cartSubTotal`, `cartTaxes`, na `cartTotal` sve da bude broj `0`.

# --hints--

Trebalo bi da postavite `textContent` elementa `totalNumberOfItems` na `0`.
...
Treba da postavite `textContent` za element `cartSubTotal` na `0`.
...
Treba da postaviš `textContent` elementa `cartTaxes` kao `0`.
...
Trebalo bi da postaviš `textContent` elementa `cartTotal` kao `0`.
