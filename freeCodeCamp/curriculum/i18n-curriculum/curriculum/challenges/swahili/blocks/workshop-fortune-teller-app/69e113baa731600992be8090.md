...
Trebalo bi da kreirate varijablu pod imenom `CDN_URL`.
...
Vaša promenljiva `CDN_URL` bi trebalo da bude set do `"https://cdn.freecodecamp.org/curriculum/typescript/tarot-app"`.
...
Trebalo bi da kreirate varijablu pod imenom `defaultImg`.
...
Vaša promenljiva `defaultImg` bi trebalo da bude set za `new URL("default.svg", import.meta.url)`.
...
Trebalo bi da kreirate varijablu pod imenom `LOCAL_DEFAULT_IMG`.
...
Vaša varijabla `LOCAL_DEFAULT_IMG` bi trebalo da bude set kako bi postala `defaultImg`.
