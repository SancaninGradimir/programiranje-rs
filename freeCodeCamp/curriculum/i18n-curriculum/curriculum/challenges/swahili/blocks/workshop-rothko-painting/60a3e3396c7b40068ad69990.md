...
Koristi deklaraciju `box-shadow` umesto `.two`, ali promeni boju sa `#efb762` na `#8f0401`.
...
Vaše polje za `.two` treba da ima vrednost `box-shadow` od `0 0 3px 3px #8f0401`.
