...
Postavi element za `.three` u sredinu crtačkog platna postavljanjem `margin` na `auto`.

# --hints--

Trebalo bi da postaviš atribut `margin` na `auto`.
...
Vaše polje za `.three` trebalo bi da ima vrednost `margin` od `auto`.
