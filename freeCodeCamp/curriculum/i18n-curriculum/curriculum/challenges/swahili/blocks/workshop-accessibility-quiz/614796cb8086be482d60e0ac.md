...
Što se tiče vizuelne dostupnosti, kontrast između elemenata je važna stvar. Na primer, odnos kontrasta između teksta i pozadine sekcijskog naslova treba da bude barem 4.5:1.

Promeni boju fonta za svih elemenata sa oznakom (anchor) unutar elementa liste tako da postoji odnos razlike boja od najmanje 7:1.

# --hints--

Vaš selektor bi trebalo da cilja na linkove unutar elemenata liste.
...
Trebalo bi da dodelite atribut `a` elementima `color` unutar lista elemenata.
...
Trebalo bi da promeniš samo boju elemenata `a` unutar liste elemenata.
...
Trebalo bi da navedete atribut `color` sa odnosom raznolikosti i osnove od najmanje 7:1. _Savet: Pošaljite mi `#dfdfe2`_
