...
U zapitanje pretrage `@media`, dodaj selektor za `.keys` i postavi `width` na `318px`.

# --hints--


Vaše pravilo za `@media` trebalo bi da ima selektor za `.keys`.
...
Tvoj novi uređaj za `.keys` mora imati `width` od `318px`.
