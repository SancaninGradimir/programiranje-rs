...
Izmeni deklaraciju svoje funkcije kako bi primila osnovne parametre. Koristi `16` za `length` i `1` za druge funkcije.

# --hints--

Vaša funkcija treba da primi osnovne parametre.
