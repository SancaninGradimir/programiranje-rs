...
Da biste kreirali nešto više prostora pored menija, dodajte `20px` prostora unutar elementa `body` koristeći svojstvo `padding`.
...
Vaše polje za `body` trebalo bi da ima `padding` od `20px`.
