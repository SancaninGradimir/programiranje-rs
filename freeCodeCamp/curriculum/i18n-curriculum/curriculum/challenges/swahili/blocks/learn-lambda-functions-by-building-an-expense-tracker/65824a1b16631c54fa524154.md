...
Sledeće, dodajte još jedan poziv za `print()` i sledeću sekvencu slova `'2. List all expenses'`.

# --hints--

Trebaće vam da umetnete `'2. List all expenses'` u vašu funkciju `while` nakon postojećih poziva `print()`.
