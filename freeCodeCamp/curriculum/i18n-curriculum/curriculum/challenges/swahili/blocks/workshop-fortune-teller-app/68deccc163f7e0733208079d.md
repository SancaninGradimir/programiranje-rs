...
Zatim, kreirajte funkciju za skrivanje elemenata iz DOM-a. Deklarišite funkciju `hideElements` koja prima `...elements` kao parametar tipa `HTMLElement[]`.
...
Trebalo je da deklarišete funkciju pod nazivom `hideElements`.
...
Vaša funkcija `hideElements` treba da ima parametar pod nazivom `...elements` sa tipom `HTMLElement[]`.
