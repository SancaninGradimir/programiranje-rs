...
Kada korisnik izmeni belešku i bilo da koristi tabulator ili klikne van kartice, trebalo bi da se prikaže poruka o statusu koja obaveštava korisnike da je beleška uspešno sačuvana.

Da biste počeli, kreirajte element `div` sa atributom `id` postavljenim na `"status"`.
