...
Konačno, pozovite `genParentheses` sa `3` kao argumentom kako biste generisali sve pet validnih kombinacija od tri standardni zagrade i napisali rezultate na konzolu.

Stoga, vaša radionica za pretragu po širini je prvi završena.

# --hints--

Treba da napišeš `genParentheses(3)`.
