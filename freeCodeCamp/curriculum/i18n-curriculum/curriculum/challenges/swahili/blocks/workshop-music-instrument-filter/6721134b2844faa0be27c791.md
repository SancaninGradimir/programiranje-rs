...
Preostali instrumenti su vam dodati u niz ``instrumentsArr``.

Sada, deklarišite dve varijable ``selectContainer`` i ``productsContainer`` i dodelite im vaš HTML padajući meni (dropdown) i element sa klasom ``products-container``, respektivno.
