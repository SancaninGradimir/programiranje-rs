...
Trenutno, funkcija `displayStory` radi dobro; vreme je za dodavanje funkcionalnosti dugmićima.

Na primer, ukloni poziv funkcije za `displayStory("scary")`.

# --hints--

Treba da uklonite poziv funkcije `displayStory("scary")`.
