...
Da bi se obezbedilo da je tekst unet u input polja i tekstualne oblasti, kao i njihovi placeholderi, vidljiv, postavite im boju.

Izaberite `input, input::placeholder, textarea` i podesite `color` na `whitesmoke`.
