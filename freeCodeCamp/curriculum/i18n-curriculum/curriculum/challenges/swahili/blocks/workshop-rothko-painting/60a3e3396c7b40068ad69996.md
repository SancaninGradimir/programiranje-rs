...
Rotiraj element `.two` po uglu za 0.4 stepena.

# --hints--

Trebalo bi da postaviš vrednost za `transform` na `rotate(0.4deg)`.
...
Vaše polje za `.two` trebalo bi da ima vrednost od `transform` za `rotate(0.4deg)`.
