...
Za svaki pravougaonik je i dalje veoma oštro.

Rotiraj svaki ugao elementa `.one` na pikselu 9, koristeći svojstvo `border-radius`.

# --hints--

Treba da postaviš atribut `border-radius` na `9px`.
...
Vaše polje `.one` treba da ima vrednost od `border-radius` za `9px`.
