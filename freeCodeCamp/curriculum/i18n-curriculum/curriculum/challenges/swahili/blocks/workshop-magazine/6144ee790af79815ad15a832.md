...
Sada ste spremni da počnete sa kreiranjem grid rasporeda. U prethodnim lekcijama ste naučili da CSS Grid nudi dvodimenzionalni raspored zasnovan na gridu, omogućavajući vam centriranje elemenata horizontalno i vertikalno, a istovremeno zadržavajući kontrolu za stvari poput preklapanja elemenata.

Počnite kreiranjem selektora `main` i dodeljivanjem mu svojstva `display`, postavljeno na `grid`.
