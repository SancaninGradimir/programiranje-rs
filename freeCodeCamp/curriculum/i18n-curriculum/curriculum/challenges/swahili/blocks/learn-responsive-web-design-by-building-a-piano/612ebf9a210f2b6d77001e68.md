...
Sada dodaj filter za `.logo` u pretraga upit od `@media`, i postavi svojstvo `width` na `150px`.

# --hints--

Vaše pravilo `@media` treba da ima selektor za `.logo`.
...
Tvoj novi selektor za `.logo` mora imati `width` od `150px`.
