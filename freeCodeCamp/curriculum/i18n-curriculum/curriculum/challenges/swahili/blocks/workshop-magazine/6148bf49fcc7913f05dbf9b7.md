...
Kreiraj selektor `.author-name a:hover` i dodeli mu svojstvo `background-color` postavljeno na `#306203`.

Ovo će stvoriti efekat prelaska mišem samo za element `a` unutar `.author-name`, prikazujući originalnu zelenu boju freeCodeCamp-a u pozadini.
