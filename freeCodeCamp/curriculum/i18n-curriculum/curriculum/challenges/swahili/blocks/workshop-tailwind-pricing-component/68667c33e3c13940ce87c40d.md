...
`span` koji ima vreme takođe zahteva određeni stil, pa dodaj klase elemenata `text-base`, `font-medium`, i `text-fuchsia-300` njemu.
...
Tvoj element za `span` mora imati klasu objekata `text-fuchsia-300`.
