...
Da bi prvi deo izgledao bolje u liniji, izaberite samo elemente od `input` unutar elemenata od `.info`, i postavite njihovo `width` na `50%`, i poravnajte njihov tekst levo.
...
Trebalo bi da im date elemente `input` `text-align` iz `left`.
