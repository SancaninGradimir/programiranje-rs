...
Da biste napravili mali razmak između elemenata `fieldset`, izaberite te elemente i date im `border-bottom` od `3px solid #3b3b4f`.

# --hints--

Trebalo bi da im date elemente `fieldset` `border-bottom` od `3px solid #3b3b4f`.
