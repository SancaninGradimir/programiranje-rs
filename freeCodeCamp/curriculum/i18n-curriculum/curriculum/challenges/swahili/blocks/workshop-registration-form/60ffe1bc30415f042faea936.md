...
Da bi elementi na `input` i `textarea` odgovarali pozadinskoj temi, postavi njihov `background-color` da bude `#0a0a23`. Zatim, dodaj im `1px`, ivica od `solid` sa bojom `#0a0a23`.

# --hints--

Treba vam da koristite selektor atributa razdvojen zarezima za odabir elemenata `input` i `textarea`.
...
Treba da im date elemente od `input` i `textarea` do `1px`, `solid` sa bojom `#0a0a23`.
