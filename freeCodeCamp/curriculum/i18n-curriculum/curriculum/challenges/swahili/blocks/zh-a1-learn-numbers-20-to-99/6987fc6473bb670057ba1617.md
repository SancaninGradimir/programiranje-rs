...
Sad je vreme da naučimo broj pedeset.

Na kineskom, broj 50 se zove `五十 (wǔ shí)`.

Brojevi od 51 do 59 se formiraju dodavanjem jednocifnog broja (1–9) nakon `五十 (wǔ shí)` (50).
...
Vežbao sam izgovor brojeva od 50 do 59.
