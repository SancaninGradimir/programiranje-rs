...
Odmah nakon vaše `if` izjave, deklarišite varijablu pod imenom `is_invalid` i postavite je na `False`. Kasnije ćete ga koristiti kao zastavicu za izvršavanje uslovne izjave.
