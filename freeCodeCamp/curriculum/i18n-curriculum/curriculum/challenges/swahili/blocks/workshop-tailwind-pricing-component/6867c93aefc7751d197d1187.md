...
Sada, `h2` za program i postavi vrednost klase objekata `text-lg`, `font-semibold`, na `text-indigo-600`.

# --hints--

Tvoj element `h2` treba da ima klasu objekata `text-lg`.
...
Vaš element za `h2` mora imati klasu objekata `font-semibold`.
...
Vaš element za `h2` treba imati klasu objekata `text-indigo-600`.
