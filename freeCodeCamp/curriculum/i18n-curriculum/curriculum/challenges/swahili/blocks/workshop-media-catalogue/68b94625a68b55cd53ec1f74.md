...
Docstringove se može pristupiti putem atributa `__doc__`, koji je podrazumevano postavljen na `None`.

Proverite ga štampanjem `movie1.__doc__` i `series1.__doc__`. Napomena da atribut `__doc__` nije nasleđen od strane bilo koje podklase.
