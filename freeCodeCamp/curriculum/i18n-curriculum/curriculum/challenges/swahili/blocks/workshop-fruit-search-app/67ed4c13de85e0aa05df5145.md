...
Povežite prikazanu vrednost unosa sa vašim React stanjem dodavanjem atributa ``value`` na vaše polje za pretragu, postavljajući ga na vrednost stanja ``query``.
