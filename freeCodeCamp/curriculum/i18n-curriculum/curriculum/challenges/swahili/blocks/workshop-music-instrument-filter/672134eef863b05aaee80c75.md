...
Da biste implementirali funkcionalnost filtriranja, biće vam potrebna funkcija. Deklarišite praznu funkciju pod imenom `instrumentCards` koja prima jedan parametar.
