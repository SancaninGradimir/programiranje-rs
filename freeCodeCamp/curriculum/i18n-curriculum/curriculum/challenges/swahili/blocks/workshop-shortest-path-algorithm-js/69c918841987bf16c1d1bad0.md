...
Funkcija mora da vrati izračunate podatke kako bi pozivajuće funkcije mogle da ih programski koriste.

Nakon ciklusa od `for...of`, dodaj deklaraciju `return` koja vraća red podataka koji sadrži `distances` i `paths`, u istom redosledu.

# --hints--

Treba da vratiš `[distances, paths]` nakon ciklusa od `for...of`.
