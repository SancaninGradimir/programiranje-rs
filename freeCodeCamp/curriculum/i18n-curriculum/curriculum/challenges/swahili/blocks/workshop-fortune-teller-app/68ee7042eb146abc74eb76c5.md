...
Trebalo bi da deklariš varijablu pod imenom `card`.
...
Vaša varijabla `card` treba da bude dodeljena pozivanjem metode `getRandomItem` sa `this.cards` as argumentom.
