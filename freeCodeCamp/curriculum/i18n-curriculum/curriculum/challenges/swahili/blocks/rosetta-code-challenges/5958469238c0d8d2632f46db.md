...
Za nenegativne cele brojeve `m` i `n`, generiši sve kombinacije veličine `m` sastavljene od celih brojeva od `0` do `n-1`, u rastućem redosledu (svaka kombinacija je sortirana, kao i cela tabela).
