...
Kopirajte i zalepite klasu `sky` zajedno sa njenim svojstvima i vrednostima unutar `media query`-a. Kreiraćete još jednu shemu boja za siluetu koja se menja od dana do noći.

Zapamtite: Morate skrolovati više ispod područja za uređivanje da biste kopirali taj razred.

# --hints--

Ne možete obrisati izjavu za `.sky` koja postoji.
...
Treba da kopirate deklaraciju `.sky` koja je unutar media query-ja.
