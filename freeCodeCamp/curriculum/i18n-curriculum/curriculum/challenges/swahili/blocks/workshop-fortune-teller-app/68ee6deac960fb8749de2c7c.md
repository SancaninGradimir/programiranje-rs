...
Trebalo bi da prosledite `chosenCard.name_short` as argumentu u `renderCard`.
...
Trebalo bi da prosledite `chosenCard.img` as poslednji argument u/na `renderCard`.
...
Trebalo bi da resetujete `this.elements.multipleCard.innerHTML` na prazan string.
