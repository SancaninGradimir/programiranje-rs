...
Napravi novi zakon za CSS koristeći selektor `.two` i postavi mu svojstvo `width` na 475 pikseli.

# --hints--

Trebalo bi da imaš birač za `.two`.
...
Trebalo bi da postaviš vrednost `width` na `475px`.
...
Vaše polje ``.two`` trebalo bi da ima vrednost ``width`` od ``475px``.
