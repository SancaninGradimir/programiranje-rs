...
Trebalo bi da imate selektor `.cabin:nth-of-type(1)`.
...
Vaš `.cabin:nth-of-type(1)` selektor bi trebalo da ima `right` svojstvo set do `-8.5%`.
...
Vaš `.cabin:nth-of-type(1)` selektor bi trebalo da ima svojstvo `top` set do `50%`.
