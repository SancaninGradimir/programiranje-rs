...
Trebalo bi da imate nešto nazvano class, to jest `Game`.
...
Trebalo bi da imate svojstvo `cards` unutar `Game` class.
...
Vaše svojstvo `cards` bi trebalo da ima tip `Card[]`.
...
Vaš atribut kartica treba da bude set do praznog `array`.
