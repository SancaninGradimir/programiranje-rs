...
Pre petlje, kreirajte novu varijablu `secret_codes` koja ima početnu vrednost praznog spiska.

Zatim zamenite liniju `return secret_code` linijom koja dodaje `secret_code` u listu `secret_codes`.
