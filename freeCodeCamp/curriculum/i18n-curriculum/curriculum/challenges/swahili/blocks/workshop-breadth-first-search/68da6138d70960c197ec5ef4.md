...
Vaša funkcija je sada završena. Pokušajte ponovo objavljivanjem `gen_parentheses(2)` umesto `gen_parentheses(1)`.

# --hints--

Trebalo bi da odštampate `gen_parentheses(2)`.
...
Ne bi trebalo da imaš `print(gen_parentheses(1))` u svom kodu
