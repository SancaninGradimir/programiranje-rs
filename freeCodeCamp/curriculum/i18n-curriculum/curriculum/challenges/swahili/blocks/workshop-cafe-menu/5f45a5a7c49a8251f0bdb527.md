...
S obzirom na isti selektor stila iz prethodnog koraka, povećajte veličinu fonta za artikle i cene koristeći vrednost od `18px`.
...
Vaši elementi za `p` koji su postavljeni unutar elemenata od `.item` moraju imati `font-size` od `18px`.
