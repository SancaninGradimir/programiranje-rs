...
Sada možete stilizovati raspored vaše mreže. CSS Grid je sličan Flexboxu po tome što ima posebnu svojstvo za roditeljske i detske elemente.

U ovom slučaju, vaš roditeljski element je element `main`. Postavite sadržaj da ima raspored od tri kolone dodavanjem svojstva `grid-template-columns` sa vrednošću `1fr 94rem 1fr`. Ovo će kreirati tri kolone gde je srednja kolona široka `94rem`, a prva i poslednja kolona su obe po 1 frakciono od preostalog prostora u kontejneru mreže.
