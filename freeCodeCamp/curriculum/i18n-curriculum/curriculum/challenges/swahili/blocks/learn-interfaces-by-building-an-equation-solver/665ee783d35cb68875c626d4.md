...
Sada, ukloni oba poziva od `print(lin_eq.solve())` i `print(lin_eq.analyze())` iz svog koda.

# --hints--

Treba da uklonite oba poziva za `print(lin_eq.solve())` i `print(lin_eq.analyze())`.
