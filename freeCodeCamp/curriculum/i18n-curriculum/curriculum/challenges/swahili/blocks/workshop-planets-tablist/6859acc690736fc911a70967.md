...
Trenutno, sve tri činjenice su vidljive istovremeno. Ali samo jedna činjenica bi trebalo da bude vidljiva u jednom trenutku.

Da biste ovo postigli, morate postaviti atribut `hidden` na drugi i treći element `tabpanel`.
