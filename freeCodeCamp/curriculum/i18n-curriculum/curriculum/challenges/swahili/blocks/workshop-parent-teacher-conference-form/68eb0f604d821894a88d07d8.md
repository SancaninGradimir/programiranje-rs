...
Da biste učinili da kontejner zađe u oči, trebali biste dodati `box-shadow` podešen na `0 5px 15px black`.

Ovo dodaje efekat senke oko kontejnera. Vrednosti kontrolišu horizontalni pomak, vertikalni pomak, radijus zamućenja i boju, respektivno.
