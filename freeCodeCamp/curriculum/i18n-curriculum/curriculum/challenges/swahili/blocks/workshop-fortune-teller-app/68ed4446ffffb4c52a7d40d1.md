...
Metoda `fetchCardsData` će se baviti učitavanjem podataka o tarotu sa API-ja, a `initializeEventListeners` će postaviti rukovače za klik na dugme. Obe metode ćete kreirati u narednim koracima.

# --hints--

Trebalo bi da pozovete metod `fetchCardsData()` unutar `constructor`.
...
Trebalo bi da pozovete metodu `initializeEventListeners()` unutar konstruktora.
