...
Sada, ne možemo čitati tekst. Fokusirajte se na `footer` i anker element unutar njega kako biste postavili boju fonta na boju sa odgovarajućim kontrastnim odnosom.

# --hints--

Trebalo bi da koristiš čitač `footer, footer a`.
...
Treba da postavite `color` na vrednost sa razmakom nijanse boje od najmanje `7:1`. _Savet: Predlažem `#dfdfe2`_
