...
Sortiraj direktno red podataka `sorted` koristeći svoju funkciju pomoći `sortByPriorityDescending()`.

# --hints--

Trebalo bi da pozoveš `sortByPriorityDescending()` kada imaš red podataka `sorted`.
