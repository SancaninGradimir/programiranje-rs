...
Koristite metodu `add` od `catalogue` da dodate `series1` u listu `items`.

Zatim, kreirajte još jednu varijablu `series2`. Dodelite joj još jedan instancu `TVSeries` i takođe dodajte `series2` u katalog.
