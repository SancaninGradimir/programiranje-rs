...
Sledeći je poslednji cenovni artikl, **Porodični plan**.

Počnite, dajte paket `div` za taj program, klase `bg-gray-100`, `ring-1`, `ring-gray-300`, `p-8`, i `rounded-xl`.

# --hints--

Vaš paket `div` za porodični plan mora imati klasu `bg-gray-100`.
...
Tvoj paket `div` za porodični plan mora imati klasu od `ring-1`.
...
Vaš paket `div` za porodični plan treba da ima klasu od `ring-gray-300`.
...
Vaš paket `div` za porodični plan mora imati klasu `p-8`.
...
Tvoj paket `div` za porodični plan treba da ima klasu od `rounded-xl`.
