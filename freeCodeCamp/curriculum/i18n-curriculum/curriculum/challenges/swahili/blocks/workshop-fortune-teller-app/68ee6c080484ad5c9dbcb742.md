...
Zapamtite da morate pristupati svim njima koristeći `this.elements`.

# --hints--

Trebalo bi da definišete metod nazvan `singleCardSelected`.
...
U okviru `singleCardSelected`, trebalo bi da pozovete funkciju `hideElements`.
...
Trebalo bi da prosledite `singleCardBtn` funkciji `hideElements`.
...
Trebalo bi da prosledite `multipleCardsBtn` funkciji `hideElements`.
...
Trebalo bi da prosledite `multipleCard` funkciji `hideElements`.
...
Trebalo bi da prosledite `text` funkciji `hideElements`.
...
Trebalo bi da prosledite `headerTitle` funkciji `hideElements`.
