...
Promeni `background-color` deo za crtanje u `#4d0f00`.

# --hints--

Trebalo bi da postavite atribut `background-color` na `#4d0f00`.
...
Vaš element od `.canvas` bi trebalo da ima `background-color` od `#4d0f00`.
