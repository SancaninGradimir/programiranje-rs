...
Zatim, morate prikazati trenutni naslov pesme i izvođača na displeju plejera.

Kao prvi korak, pristupite elementima `#player-song-title` i `#player-song-artist`, odgovornim za prikaz naslova pesme i izvođača, i sačuvajte ih u varijable `playingSong` i `songArtist`, respektivno.
