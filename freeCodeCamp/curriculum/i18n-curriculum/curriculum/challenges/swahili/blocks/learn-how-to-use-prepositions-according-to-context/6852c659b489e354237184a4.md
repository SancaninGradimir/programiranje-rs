...
Gde je kancelarija za podršku korisnicima?

## --answers--

Blizu ulaznih vrata, pored recepcije.

### --feedback--

Ti podaci odgovaraju HR odelju.

---

Iza sala za sastanaka, u sredini poda.

---

Pored marketinškog tima.
...
Ispred hitnih vrata, blizu IT-a.

### --feedback--

Ovo opisuje lokaciju IT odeljenja.
...
Bob objašnjava da je podrška za klijente na `placed behind the conference rooms, in a central area in the middle of the floor`. Dodaje da ih ovo čini `easily reachable by all teams`.

Pogledajte sekciju o `Customer support` u pregledu podešavanja.