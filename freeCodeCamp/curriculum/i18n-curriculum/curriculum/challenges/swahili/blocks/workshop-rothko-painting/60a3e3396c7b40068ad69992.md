...
Ugle na svakom pravougaoniku su i dalje veoma oštri.

Rotiraj svaki ugao elementa `.one` za pikselu 9, koristeći svojstvo `border-radius`.

# --hints--

Treba da postaviš vrednost za `border-radius` na `9px`.
...
Vaše polje za `.one` trebalo bi da ima vrednost od `border-radius`, koja je `9px`.
