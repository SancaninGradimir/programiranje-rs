...
Trebalo bi da prosledite `singleCardBtn` as prvi argument funkciji `showElements`.
...
Trebalo bi da prosledite `multipleCardsBtn` as drugi argument funkciji `showElements`.
...
Trebalo bi da prosledite `headerTitle` as argument funkciji `showElements`.
