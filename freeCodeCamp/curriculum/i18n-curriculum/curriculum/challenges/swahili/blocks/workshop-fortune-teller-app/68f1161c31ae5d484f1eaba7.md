...
Trebalo bi da deklariš metod nazvan `showFortune`.
...
Vaš `showFortune` metoda bi trebalo da ima `e` parametar tipa `Event`.
...
Trebalo bi da deklarišete metodu pod nazivom `newReading`.
