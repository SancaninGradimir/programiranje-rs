...
*Napomena*: Nije preporučljivo koristiti sekvencijalno povezivanje za ovaj korak jer to eksplicitno postavlja svojstva `currentSong` i `songCurrentTime` na `null` i `0` odgovarajuće.
