...
Trebalo bi da imate svojstvo `multipleCard` unutar svojstva `elements`, dodeljeno tipu `HTMLElement`.
...
Trebalo bi da imate svojstvo `title` unutar svojstva `elements` sa dodeljenim tipom `HTMLElement`.
...
Trebalo bi da imate svojstvo `newReadingBtn` unutar svojstva `elements`, koje je tipizovano kao `HTMLElement`.
...
Trebalo bi da imate svojstvo `fortuneContainer` unutar svojstva `elements`, koje je tipizovano kao `HTMLElement`.
...
Trebalo bi da imate svojstvo ``fortuneDescription`` unutar svojstva ``elements`` dodeljeno tipu ``HTMLElement``.
...
Trebalo bi da imate svojstvo `headerTitle` unutar svojstva `elements` dodeljeno tipu `HTMLElement`.
...
Trebalo bi da imate svojstvo `subTitle` unutar svojstva `elements` dodeljeno tipom `HTMLElement`.
...
Trebalo bi da imate svojstvo `cardTitle` unutar svojstva `elements` sa tipom `HTMLElement`.
...
Trebalo bi da imate svojstvo `description` unutar svojstva `elements` dodeljeno tipom `HTMLElement`.
...
Trebalo bi da imate svojstvo `text` unutar svojstva `elements`, dodeljeno tipu `HTMLElement`.
