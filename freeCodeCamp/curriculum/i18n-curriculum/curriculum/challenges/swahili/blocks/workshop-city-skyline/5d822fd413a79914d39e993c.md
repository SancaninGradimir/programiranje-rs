...
U klasi za medijski upit `sky`, promenite dve vrednosti boja od `#ffcf33` u `#ccc`, `#ffff66` u `#445`, i od `#bbeeff` u `#223`. Zatim možete promeniti veličinu prozora da vidite kako se menja pozadinska boja.
...
Treba da promeniš drugu vrednost boje od `#ffff66` do `#445`.
...
Trebalo bi da promeniš treću vrednost boje sa `#bbeeff` na `#223`.
