...
Postavi unutar prvog elementa od `textarea`, unutar drugog elementa od `div.answer`, i ubaci broj redova i kolona koje poseduje.

# --hints--

Treba da ga postavite unutar prvog elementa od `textarea`, a zatim i u drugi element od `div.answer`.
