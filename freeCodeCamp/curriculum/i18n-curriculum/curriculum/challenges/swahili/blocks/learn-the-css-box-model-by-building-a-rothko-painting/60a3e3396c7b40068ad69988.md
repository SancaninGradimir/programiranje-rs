...
Postavi atribut za `height` od `.three` na `28%`.

# --hints--

Trebalo bi da postaviš vrednost za `height` na `28%`.
...
Vaše polje za `.three` trebalo bi da ima vrednost od `height` koja je `28%`.
