...
Za vaš `textarea` element, dodajte atribut `id` i `name` sa vrednošću `"comments"`. 

Za atribut `cols` postavite vrednost na `30`, a za atribut `rows` postavite vrednost na `10`.
