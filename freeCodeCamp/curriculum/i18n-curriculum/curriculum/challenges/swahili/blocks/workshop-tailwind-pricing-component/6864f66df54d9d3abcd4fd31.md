...
Elementu `span` unutar elementa `p` sa tekstom `/month` dodeli klase `text-base`, `font-medium` i `text-gray-500`. Time će se razlikovati od same cene tako što će tekst biti svetliji.
