...
Izmenite vaš poziv ``console.log`` da bi logovao izabrana vrednost sa padajućeg menija. 

Možete pristupiti trenutnoj vrednosti elementa ``select`` koristeći njegovu svojstvo ``.value``. Primer:
