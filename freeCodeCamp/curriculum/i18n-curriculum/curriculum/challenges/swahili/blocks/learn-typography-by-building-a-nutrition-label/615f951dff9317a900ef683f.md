...
Ukloni unutrašnji razmak sa leve i desne strane za elemente/izbore `.note` koji su `8px`, uklanjajući gornji i donji unutrašnji razmak. Takođe postavi atribut za `text-indent` na `-8px`.

Nakon ovih poslednjih promena, vaša nutritivna oznaka će biti kompletirana!

# --hints--

Vaš selektor za `.note` mora imati svojstvo `padding` postavljeno na `0 8px`.
...
Vaš selektor za `.note` mora imati svojstvo `text-indent` postavljeno na `-8px`.
