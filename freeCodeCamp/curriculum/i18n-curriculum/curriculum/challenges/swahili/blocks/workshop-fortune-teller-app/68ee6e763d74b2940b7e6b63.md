...
Unutar metode, pozovite funkciju `hideElements` i prosledite svojstva `singleCard`, `singleCardBtn`, `multipleCardsBtn`, i `headerTitle`. Ne zaboravite da ih morate pristupiti iz `this.elements`.

# --hints--

Trebalo bi da deklarišete metod `multipleCardSelected`.
...
Trebalo bi da pozovete funkciju `hideElements` unutar metode `multipleCardSelected`.
...
Trebalo bi da prosledite `singleCard` as kao prvi argument funkciji `hideElements`.
...
Trebalo bi da prosledite `singleCardBtn` as argument funkciji `hideElements`.
...
Trebalo bi da prosledite `multipleCardsBtn` as kao argument funkciji `hideElements`.
...
Trebalo bi da prosledite `headerTitle` as argument funkciji `hideElements`.
