...
Drugi deo HTML je već dostupan za vas. Ovo uključuje kartice/karticu za premijum i porodični paket. Stoga, vreme je da stilizujete elemente HTML koristeći Tailwind CSS.

Počnite primenom blage sivo boje za celu stranicu postavljanjem klase ``body`` na element ``bg-gray-100``.

# --hints--

Vaš body element treba da ima klasu `bg-gray-100`.
