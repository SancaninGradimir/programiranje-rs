...
Da biste specificirali medijski resurs za video, moraćete da dodate atribut `src` na element `source`.

Dodajte atribut `src` sa vrednošću `https://cdn.freecodecamp.org/curriculum/labs/what-is-the-map-method-and-how-does-it-work.mp4`.
