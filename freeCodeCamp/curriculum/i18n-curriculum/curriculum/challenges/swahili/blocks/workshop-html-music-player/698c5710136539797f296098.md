...
Ispod elementa `p`, dodajte element `audio`, dodelite mu atribut `src` sa vrednošću `https://cdn.freecodecamp.org/curriculum/js-music-player/cruising-for-a-musing.mp3`, i atribute `loop` i `controls`.
