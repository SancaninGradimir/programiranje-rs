...
Klasi `ShoppingCart` i dalje nedostaje još nekoliko delova, ali prvo treba da budete u mogućnosti da testirate kod koji ste do sada napisali. Potrebno je da <dfn>napravite novu instancu</dfn> objekta `ShoppingCart` i sačuvate je u promenljivoj. Evo primera kreiranja instance klase `Computer` iz prethodnih primera:
