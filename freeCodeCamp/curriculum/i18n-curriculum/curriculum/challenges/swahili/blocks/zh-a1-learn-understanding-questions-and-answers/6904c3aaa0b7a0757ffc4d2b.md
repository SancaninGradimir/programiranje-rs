...
Wang Hua pita osobu za njeno ime. Koristi reč koja znači "da se zove" ili "zahtevano ime".
...
Ovo slovo znači „nazvano“ ili „dodeljeno ime“.

# --explanation--

`叫 (jiào)` ima značenje "nazvan". Često se koristi nakon što lik spomene ime. Na primer:
