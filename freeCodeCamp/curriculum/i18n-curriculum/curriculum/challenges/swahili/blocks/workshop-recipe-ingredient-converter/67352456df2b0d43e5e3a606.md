...
Dajte vašem `conversionTable` svojstvo `gram`, i dodelite mu objekat sa svojstvom `cup` postavljeno na `1/240`, svojstvom `ounce` postavljeno na `0.0353`, i svojstvom `teaspoon` postavljeno na `0.2`.
