...
Kako Brajan treba da odgovori da pokaže da razume Sarin argument?
...
Ovaj odgovor pokazuje neslaganje.
...
`That makes sense` se često koristi da pokaže razumevanje i slaganje sa nečijim objašnjenjem.

Pošto Sara objašnjava razliku između `building in-house` i `outsourcing`, ovaj odgovor potvrđuje da Brajan smatra da njeno objašnjenje ima smisla.
