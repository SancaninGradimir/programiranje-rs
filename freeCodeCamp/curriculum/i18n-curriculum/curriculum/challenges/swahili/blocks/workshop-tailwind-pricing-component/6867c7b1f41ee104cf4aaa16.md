...
Sada, koristićeš `grid` za organizovanje stvari unutar pakovanja `div`.

Dodaj klase stavki `grid`, `grid-rows-[1fr_auto]`, i `gap-6` u pakovanje `div`.

# --hints--

Paket za `div` za porodični plan mora imati klasu objekata `grid`.
...
Vaš paket `div` za porodični plan treba da ima klasu objekata `grid-rows-[1fr_auto]`.
...
Vaš paket `div` za porodični plan treba da ima klasu objekata `gap-6`.
