...
Postavi svojstvo `background-color` za `.one` na `#efb762`.

# --hints--

Trebalo bi da postaviš atribut `background-color` na `#efb762`.
...
Vaše polje `.one` trebalo bi da ima vrednost `background-color` od `#efb762`.
