...
`age` ne bi trebalo da bude samo ceo broj, već treba da bude pozitivan ceo broj veći ili jednak `18`.

Korišćenjem operatera `and`, dodajte drugi izraz na vrednost ključa `age` kako biste to proverili.
