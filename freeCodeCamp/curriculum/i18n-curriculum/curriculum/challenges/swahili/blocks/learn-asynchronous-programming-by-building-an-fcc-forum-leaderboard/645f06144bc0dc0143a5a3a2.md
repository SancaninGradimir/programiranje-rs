...
Svaka objava na forumu će sadržati spisak avatara korisnika koji predstavljaju sve učesnike u diskusiji o toj temi.

Počnite kreiranjem funkcije sa strelicom nazvane `avatars`, koja ima dva parametra: `posters` i `users`.
