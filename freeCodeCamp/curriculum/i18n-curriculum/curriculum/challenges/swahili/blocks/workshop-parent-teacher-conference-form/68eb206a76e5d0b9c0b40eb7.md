...
Vreme je da stilizujemo elemente `fieldset` kako bismo im dali prepoznatljiv okvir.

Izaberite element `fieldset`. Postavite mu `border` na `1px solid gray`, `border-radius` na `5px`, `margin` na `20px 0`, i `padding` na `20px`.
