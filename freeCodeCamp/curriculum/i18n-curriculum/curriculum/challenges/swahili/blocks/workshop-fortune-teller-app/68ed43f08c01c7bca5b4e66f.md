...
Treba da pristupite `multipleCardsBtn` koristeći `getElement` metod i prosleđujući `#btn-multiple-cards`.
...
Trebalo bi da pristupite `multipleCard` korišćenjem metode `getElement` i prosleđivanjem `.multiple_card`.
...
Trebalo bi da pristupite `title` korišćenjem metode `getElement` i prosleđivanjem `.title`.
...
Trebalo bi da pristupite `newReadingBtn` koristeći metod `getElement` i prosleđujući `.btn_reveal`.
...
Trebalo bi da pristupite `fortuneContainer` korišćenjem metode `getElement` i prosleđivanjem `.fortune_container`.
...
Trebalo bi da pristupite `fortuneDescription` korišćenjem metode `getElement` i prosleđivanjem `.fortune_description`.
...
Trebalo bi da pristupite `headerTitle` koristeći `getElement` metod i prosleđivanjem `.header_title`.
...
Trebalo bi da pristupite `subTitle` koristeći metod `getElement` i prosleđujući `.sub_title`.
...
Trebalo bi da pristupite `cardTitle` koristeći metod `getElement` i prosleđujući `.desc_title`.
...
Trebalo bi da pristupite `description` korišćenjem `getElement` metode i prosleđivanjem `.description`.
...
Trebalo bi da pristupite `text` korišćenjem metode `getElement` i prosleđivanjem `.text`.
