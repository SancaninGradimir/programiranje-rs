...
Sada, promenite četiri sistema iz liste `constraints` u sekvencu sirovih karaktera.

# --hints--

Treba da promeniš sekvencu od četiri slova unutar liste `constraints` u sirovan niz slova.
