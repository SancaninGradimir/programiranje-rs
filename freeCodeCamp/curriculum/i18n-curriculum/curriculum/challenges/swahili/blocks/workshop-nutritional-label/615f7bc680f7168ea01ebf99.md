...
Sada ćete morati da dodate odvojene razdelnike ispod vaših `.no-divider` elemenata.

Vaš prvi `.no-divider` element ima `.divider` posle njega. Kreirajte još jedan `.divider` nakon vašeg drugog `.no-divider` elementa.
