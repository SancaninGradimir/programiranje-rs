...
Treći red pesme nedostaje treća reč, pa je pin kraći nego što se očekuje.

Dodajte klauzulu `else` koja konkatenuje `'0'` sa `secret_code` kada nema dovoljno reči, tako da se svi redovi pesme koriste za pronalaženje cifara.
