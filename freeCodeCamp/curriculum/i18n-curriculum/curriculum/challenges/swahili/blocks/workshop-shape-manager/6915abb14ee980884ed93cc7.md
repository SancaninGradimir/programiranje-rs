...
Unutar ciklusa, dodajte `oninput` za svaki element od `input` da bude funkcija od `handleInput`.

Dakle, radionica za upravljača oblikom je završena!

# --hints--

Trebalo bi da postaviš `input.oninput` kao funkciju za `handleInput`.
