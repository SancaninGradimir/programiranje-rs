...
Vaš zadnji element je omogućiti korisnicima da obrišu svoje kupljeno vozilo. Dodajte metodu `clearCart()` u klasu `ShoppingCart`.

# --hints--

Vaša klasa od `ShoppingCart` treba da ima metodu za `clearCart`.
