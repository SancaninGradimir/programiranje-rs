...
Na kraju, promenite deklaraciju `timmyAge` i postavite je na broj manji od `16`. Nakon toga ćete videti da je `"Timmy is not old enough to drive."` logovan u konzolu.
