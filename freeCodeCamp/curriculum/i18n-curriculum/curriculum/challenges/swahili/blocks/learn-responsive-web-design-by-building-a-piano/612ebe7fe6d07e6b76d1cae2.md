...
Dodaj novi selektor za `#piano` unutar vašeg pretraga upita `@media`, i postavi `width` na `358px`.

# --hints--

Tvoja `@media` treba da ima biranje `#piano`.
...
Tvoj novi uređaj za `#piano` treba da ima `width` od `358px`.
