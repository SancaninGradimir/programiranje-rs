...
Dodajte blok `else`. Unutar bloka `else`, pozovite funkciju `playSong` sa `id` trenutno reprodukovane pesme kao argumentom.

Ovo osigurava da će trenutno reprodukovana pesma nastaviti da se reprodukuje kada se klikne na dugme za reprodukciju.
