...
Konačno, uradi isto za `instrument_2`. Pozovi metodu `play()` na `instrument_2`, a zatim odštampaj rezultat pozivanja `get_fact()` na `instrument_2`.

Ovo će dovršiti vaš radionicu muzičkih instrumenata!
