...
Zato što smanjuješ samo jedan od `i`, možeš da koristiš <dfn>opereta ya kupunguza</dfn> `--`.

Promenite vašu težinsku distribuciju smanjenja za operaciju smanjivanja.

# --hints--

Tvoj ciklus za `for` ne bi trebalo da koristi koeficijent vrednosti smanjenja.
...
Tvoj ciklus `for` treba da koristi operater smanjenja.
