...
Prednost kreiranja ovih separatora je što možete primeniti specifične klase za njihovo individualno stilizovanje. Add `double-indent` to the `class` for your last `.divider`.
