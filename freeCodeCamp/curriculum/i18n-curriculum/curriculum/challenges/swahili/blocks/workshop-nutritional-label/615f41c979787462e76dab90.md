...
Vaša nova klasa još nema stilizovanje. Kreirajte `.bold` selektor i dodelite mu svojstvo `font-weight`, postavljeno na `800`, da biste tekst učinili podebljanim.

Takođe uklonite svojstvo `font-weight` iz vašeg `h1` selektora.
