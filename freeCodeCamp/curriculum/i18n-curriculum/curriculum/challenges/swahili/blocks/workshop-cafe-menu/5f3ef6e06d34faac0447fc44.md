...
Neka ``Est. 2020`` bude niz znakova za petlju kako bi se kreirao izbor klase objekata ``established`` i mu dodeljena svojstvo ``font-style`` sa vrednošću ``italic``.
...
Trebalo bi da postaviš vrednost za `font-style` na `italic`.
