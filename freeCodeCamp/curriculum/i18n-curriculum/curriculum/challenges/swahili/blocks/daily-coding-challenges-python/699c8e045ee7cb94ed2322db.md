...
Ako je dat niz brojeva razdvojenih različitim znakovima interpunkcije, vrati najveći broj.

- Dati string će sadržati samo brojeve i znakove interpunkcije.
- Znakovi interpunkcije mogu biti zarez (`","`), uzvičnik (`"!"`), upitnik (`"?"`), dvotačka (`":"`) ili tačka-zarez (`";"`).
