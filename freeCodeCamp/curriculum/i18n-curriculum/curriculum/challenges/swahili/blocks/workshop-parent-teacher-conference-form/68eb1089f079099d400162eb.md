...
Dodali ste klasu `center` nekim elementima u HTML-u. Sada, trebali biste definisati tu klasu da centrirate te elemente.

Ciljajte klasu `center` i centrirajte elemente koji je imaju sa svojstvom `text-align` postavljeno na `center`.
