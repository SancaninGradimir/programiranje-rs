...
Reviste često koriste tekst sa opravdanim poravnanjem u svom štampanom sadržaju kako bi strukturirali raspored i kontrolisali tok svog sadržaja. Iako ovo funkcioniše u štampanoj formi, tekst sa opravdanim poravnanjem na veb stranicama može predstavljati problem pristupačnosti, na primer stvarajući izazove za osobe sa disleksijom.

Da biste učinili da vaš projekat izgleda kao štampani revija, dodelite selektoru `.text` svojstvo `text-align`, postavljeno na `justify`.
