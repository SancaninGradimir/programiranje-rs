...
Dodaj `box-shadow` za `.three` sa vrednostima za `0 0 5px 5px #b20403`.

# --hints--

Trebalo bi da postaviš atribut `box-shadow` na `0 0 5px 5px #b20403`.
...
Vaše polje za `.three` trebalo bi da ima vrednost `box-shadow` za `0 0 5px 5px #b20403`.
