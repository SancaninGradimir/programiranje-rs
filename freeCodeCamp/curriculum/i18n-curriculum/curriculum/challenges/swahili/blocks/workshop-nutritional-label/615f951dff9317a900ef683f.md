...
Postavite selektoru `.note` levinu i desni padding od `8px`, uklanjajući gornji i donji padding. Takođe postavite svojstvo `text-indent` na `-8px`.

Ovim poslednjim promenama, vaša tabela nutritivnih vrednosti je kompletna!
