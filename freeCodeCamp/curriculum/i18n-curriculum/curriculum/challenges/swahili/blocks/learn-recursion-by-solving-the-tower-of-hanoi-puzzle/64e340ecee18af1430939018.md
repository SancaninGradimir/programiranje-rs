...
Nakon drugog poziva od `move`, dodaj poslednji komentar koji kaže `move the n - 1 disks that we left on auxiliary onto target`.

# --hints--

Treba da dodate komentar koristeći priloženi tekst.
