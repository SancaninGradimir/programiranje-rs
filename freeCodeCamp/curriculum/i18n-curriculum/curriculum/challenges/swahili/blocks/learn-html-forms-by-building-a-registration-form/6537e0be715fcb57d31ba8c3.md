...
Konačno, promenite boju teksta za element veze ``terms and conditions`` u ``#dfdfe2`` dodavanjem novog selektora u `CSS`.

Čestitam! Završili ste poslednji deo vežbnog projekta - Registracioni obrazac.

# --hints--


Trebalo bi mu dati atribut `a` `color` od `#dfdfe2`.
