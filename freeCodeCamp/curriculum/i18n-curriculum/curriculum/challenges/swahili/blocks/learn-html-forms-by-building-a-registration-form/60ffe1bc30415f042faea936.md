...
Da bi elementi `input` i `textarea` odgovarali pozadinskoj temi, postavi im `background-color` da budu `#0a0a23`. Zatim, dodaj im `1px`, granicu od `solid` sa bojom `#0a0a23`.

# --hints--

Trebalo bi da koristite selektor elemenata razdvojen sa zarezima za odabir elemenata `input` i `textarea`.
...
Trebalo bi da im date elemente `input` i `textarea` `background-color` iz `#0a0a23`.
...
Trebalo bi da im date elemente sa `input` i `textarea` do `1px`, `solid` sa bojom `#0a0a23`.
