...
Da bi se citatni tekst više istakao, dodelite selektoru `.quote` svojstvo `font-family` postavljeno na `Raleway` sa rezervnom vrednošću (fallback) od `sans-serif`.
