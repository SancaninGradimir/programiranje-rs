...
Sada, trebalo bi da pređete na `Start listening` CTA kako biste ga učinili validnim dugmetom.

Postavi klasu stavki usluge `bg-indigo-100`, `px-4`, `py-2`, `text-center`, `font-semibold`, `text-indigo-700`, na `hover:bg-indigo-200`.

# --hints--

Tvoj anker element treba da ima klasu objekata `bg-indigo-100`.
...
Anker element treba da ima klasu objekata `px-4`.
...
Tvoj jangorski element treba da ima klasu elemenata `py-2`.
...
Tvoja sidrena karakteristika bi trebalo da ima klasu objekata `text-center`.
...
Vaš anker element treba da ima klasu objekta `font-semibold`.
...
Tvoj anker element bi trebalo da ima klasu objekata `text-indigo-700`.
...
Vaš jangkirni element treba da ima klasu objekata `hover:bg-indigo-200`.
