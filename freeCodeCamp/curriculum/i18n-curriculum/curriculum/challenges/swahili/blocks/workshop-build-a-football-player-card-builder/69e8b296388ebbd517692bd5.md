...
Za PHY dodajte `label` sa `htmlFor` vrednošću `phy` i tekstom `PHY`, a zatim `input` sa `id` vrednošću `phy` i `type` vrednošću `number`.
...
Peti `div` element sa `className` vrednošću `form-group` treba da sadrži `label` sa `htmlFor` vrednošću `def`, `className` vrednošću `label` i tekstom `DEF`.
...
Šesti `div` element sa `className` vrednošću `form-group` treba da sadrži `label` sa `htmlFor` vrednošću `phy`, `className` vrednošću `label` i tekstom `PHY`.
