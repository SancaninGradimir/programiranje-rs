...
Unutar funkcije `playSong`, pozovite funkciju `highlightCurrentSong`.

Nakon toga, eksperimentišite sa kontrolnim dugmićima da biste videli kako radi funkcija `highlightCurrentSong`.
