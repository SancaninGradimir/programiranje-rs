...
Sada je vreme da dodamo činjenice za svaku planetu. Unutar prvog `p` elementa, dodajte sledeći tekst:
...
Unutar drugog `p` elementa, dodajte sledeći tekst:
...
Unutar trećeg `p` elementa, dodajte sledeći tekst:
