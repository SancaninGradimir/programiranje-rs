...
Sada je vreme za prilagođavanje radijumskih dugmadi. Podrazumevano, radijumska dugmad imaju ugrađen izgled pretraživača. Želite da uklonite ovo kako biste kreirali prilagođeni izgled.

Izaberite element sa klasom `contact-method-radio-btn`. Postavite `appearance` na `none`.
