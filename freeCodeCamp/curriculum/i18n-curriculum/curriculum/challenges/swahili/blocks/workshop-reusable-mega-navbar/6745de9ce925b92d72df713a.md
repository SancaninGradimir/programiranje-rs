...
U svakom elementu od `li`, kreiraj anker element sa atributom elementa `href` postavljenim na `#`.

# --hints--

Treba da kreiraš novi element `a` unutar svakog elementa liste i postavi njegovu svojstvo elementa na `href` kao `#`.
