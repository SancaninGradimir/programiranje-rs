...
Pošto je `associatedPanel` `id`, to će vam omogućiti da upitate dokument i pronađete odgovarajući element panela. 

Kreirajte novu varijablu nazvanu `panel` i dodelite joj vrednost `document.getElementById(associatedPanel)`.
