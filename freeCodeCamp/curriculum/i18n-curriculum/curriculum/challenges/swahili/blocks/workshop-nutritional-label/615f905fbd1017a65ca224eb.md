...
Dodajte srednji razdvojnik nakon vašeg `.daily-value` elementa. Ispod tog novog razdvojnika, kreirajte `p` element sa atributom `class` postavljenim na `note`.

Dajte `p` elementu sledeći tekst:
