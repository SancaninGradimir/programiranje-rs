...
Odredi sve elemente od `label` unutar elemenata od `.info`, i postavi njihovo `width` na `10%`, i postavi ih da ne budu manje od `55px`.
...
Trebalo bi da im date elemente od `label` `width` iz `10%`.
