...
Sledeće, postavi boju za crvenu na `0%`, boju za zelenu na `50%`, i boju za plavu na `100%`.

# --hints--

Vaše pravilo za `.red` od CSS mora imati svojstvo `background`, postavljeno na `linear-gradient(180deg, rgb(255, 0, 0) 0%, rgb(0, 255, 0) 50%, rgb(0, 0, 255) 100%)`.
