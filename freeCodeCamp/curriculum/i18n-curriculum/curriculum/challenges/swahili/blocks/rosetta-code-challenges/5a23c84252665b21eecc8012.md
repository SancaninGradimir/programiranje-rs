...
title: Algoritmi za kupanga/stooge sort
challengeType: 1
forumTopicId: 302318
...
Napišite funkciju koja implementira Stooge Sort na niz podataka celih brojeva. Funkcija treba da vrati sortirani niz podataka.

Algoritam Stooge Sort-a je sledeći:
...
`stoogeSort` To treba da bude funkcija.

```js
assert(typeof stoogeSort == 'function');
```

`stoogeSort([25, 32, 12, 7, 20])` Trebalo bi da vrati red podataka.

```js
assert(Array.isArray(stoogeSort([25, 32, 12, 7, 20])));
```

`stoogeSort([25, 32, 12, 7, 20])` treba da vrati `[7, 12, 20, 25, 32]`.

```js
assert.deepEqual(stoogeSort([25, 32, 12, 7, 20]), [7, 12, 20, 25, 32]);
```

`stoogeSort([38, 45, 35, 8, 13])` treba da vrati `[8, 13, 35, 38, 45]`.

```js
assert.deepEqual(stoogeSort([38, 45, 35, 8, 13]), [8, 13, 35, 38, 45]);
```

`stoogeSort([43, 36, 20, 34, 24])` treba da vrati `[20, 24, 34, 36, 43]`.

```js
assert.deepEqual(stoogeSort([43, 36, 20, 34, 24]), [20, 24, 34, 36, 43]);
```

`stoogeSort([12, 33, 26, 18, 1, 16, 38])` bi trebalo da vrati `[1, 12, 16, 18, 26, 33, 38]`.
...
`stoogeSort([3, 39, 48, 16, 1, 4, 29])` treba vratiti `[1, 3, 4, 16, 29, 39, 48]`.
