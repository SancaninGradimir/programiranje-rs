...
Sada možete početi da gradite svoju listu. Koristite `addCrewMember()` da dodate `firstAstronaut` u vaš `squad`.

# --hints--

Trebalo bi da pozoveš `addCrewMember()` na `squad` na `firstAstronaut`.
