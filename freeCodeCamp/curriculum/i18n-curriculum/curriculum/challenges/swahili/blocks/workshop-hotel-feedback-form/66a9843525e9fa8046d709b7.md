...
Za poslednji korak u radionici za formular povratnih informacija o hotelu, moraćete da dodate dugme za slanje na formular.

Zapamtite da ste u prethodnim časovima naučili kako da radite sa dugmićima za slanje.

Dodajte element `button` sa atributom `type` podešenim na `"submit"` i tekstualnim sadržajem podešenim na `Submit`.

I time je vaš formular povratnih informacija o hotelu završen!
