...
Sada ćete morati da kreirate svoju prvu kurirana funkciju. Zapamtite da je kurirana funkcija funkcija koja vraća drugu funkciju, kao što je ovde:
...
Počnite sa deklarisanjem funkcije `convertQuantity`. Trebalo bi da ima jedan parametar `fromUnit`, i treba da bude prazna.
