...
Ispod elementa blok citata, dodajte paragraf element sa tekstom `&mdash;Quincy Larson, How to Learn to Code and Get a Developer Job [Full Book]`.

`&mdash;` je HTML entitet koji predstavlja em crtu `—`.
