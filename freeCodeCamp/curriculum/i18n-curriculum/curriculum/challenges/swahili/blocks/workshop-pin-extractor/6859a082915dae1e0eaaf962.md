...
Konačno, vratite `secret_codes`, zatim dekomentujte poziv funkcije i ažurirajte argument da bude `[poem, poem2, poem3]`. Sada vaša funkcija radi sa više pesama odjednom i može da izvuče više pinova!

Funkcija `pin_extractor` je završena.
