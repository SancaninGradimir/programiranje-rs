...
Kada uzmete u obzir istu sintaksu, ispravite `c` ili slično kao `c`, `{`, `[`, na `(`.

# --hints--

`stockRegex` treba da koristi klasu znakova kako bi odgovaralo `c`, `{`, `[`, i `(`.
...
`stockRegex` vaše bi trebalo da odgovara na `sto{k alert`.
