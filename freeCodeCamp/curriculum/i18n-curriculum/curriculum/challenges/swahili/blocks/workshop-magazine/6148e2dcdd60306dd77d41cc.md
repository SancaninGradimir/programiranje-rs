...
Vreme je da stilizujemo poslednji deo magazina – slike.

Slike su obuhvaćene elementom `aside` koristeći klasu `image-wrapper`, pa kreirajte selektor `.image-wrapper`. Postavite svojstvo `display` na `grid`.
