...
Kada zumirate pažljivo, videćete elemente `.inline` koji su veoma visoko na liniji.

Da biste ovo obradili, postavite atribut `vertical-align` na `middle`.

# --hints--

Trebalo bi postaviti atribut `vertical-align` na `middle` za sve komponente od `.inline`.
