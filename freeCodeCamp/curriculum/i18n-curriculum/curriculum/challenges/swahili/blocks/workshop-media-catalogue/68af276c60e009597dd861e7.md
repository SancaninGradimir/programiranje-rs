...
Na kraju, kreirajte jednu poslednju `if` izjavu da proverite da li `duration` nije veće od `0` i bacite/izbacite `ValueError` sa porukom `Duration must be positive`.
