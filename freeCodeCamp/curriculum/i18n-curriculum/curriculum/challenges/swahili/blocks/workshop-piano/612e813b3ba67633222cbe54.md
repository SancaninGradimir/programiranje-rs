...
Zapamtite, atribut `class` može da sadrži više vrednosti. Da biste razlikovali svoje bele i crne tastere, dodajte drugu vrednost `class` od `black--key` vašim drugim, trećim, petim, šestim i sedmom elementu `.key`.
