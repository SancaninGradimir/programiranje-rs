...
Kreiraj još jednu izjavu `if` za proveru da li `director` nije prazan ili sadrži samo razmake i generiše/izbaci `ValueError` sa porukom `Director cannot be empty`.
