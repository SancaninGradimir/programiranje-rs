...
Trenutno, ako pišete u elementima `input` ili `textarea`, nećete moći da vidite tekst. Takođe, njihova dužina je previše mala za lako korišćenje.

Ispravite ovo zamjenom `color` sa `#ffffff`, i zamjenom `min-height` sa `2em`.
