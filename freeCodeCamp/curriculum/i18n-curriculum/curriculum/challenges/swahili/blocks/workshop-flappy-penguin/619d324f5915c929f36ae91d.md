...
Trebalo bi dodati a `10%` waypoint for `@keyframes wave`.
...
Trebalo bi dodati `20%` waypoint for `@keyframes wave`.
...
Trebalo bi dodati `30%` tačku puta for `@keyframes wave`.
...
Trebalo bi da dodate tačku puta `40%` for `@keyframes wave`.
...
Trebalo bi da imate 4 tačke za navigaciju (waypoints) u vašem keyframe-u.
