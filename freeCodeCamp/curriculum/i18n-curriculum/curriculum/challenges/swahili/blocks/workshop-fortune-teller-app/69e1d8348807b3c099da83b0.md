...
U ovom trenutku, videćete da možete videti karte kada kliknete na dugmad Single Card Reading i Three Card Spread.

# --hints--

Trebalo bi da deklariš varijablu pod imenom `game`.
...
Vaša promenljiva `game` treba da bude inicijalizovana sa `new Game()`.
