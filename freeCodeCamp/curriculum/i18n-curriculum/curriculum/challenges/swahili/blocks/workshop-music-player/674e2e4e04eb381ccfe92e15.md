...
Sada je vreme da testiramo dugme za pauziranje.

Dodajte ``"click"`` slušalicu događaja na element ``pauseButton``, a zatim prosledite ``pauseSong`` kao drugi argument slušalice događaja. Ovo je funkcija koju će slušalica događaja izvršiti.

Testirajte svoju aplikaciju tako što ćete prvo kliknuti na dugme za reprodukciju, a zatim i na dugme za pauzu. Trebalo bi da vidite da sve radi kako je očekivano.
