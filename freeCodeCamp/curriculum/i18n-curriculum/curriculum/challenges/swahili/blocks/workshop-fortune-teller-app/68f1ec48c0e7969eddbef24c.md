...
Treba da prosledite `singleCard` as prvi argument u `hideElements`.
...
Trebalo bi da prosledite argument na `multipleCard` as u `hideElements`.
...
Trebalo bi da prosledite `fortuneContainer` as argument u `hideElements`.
...
Trebalo bi da prosledite `fortuneDescription` as argument u `hideElements`.
