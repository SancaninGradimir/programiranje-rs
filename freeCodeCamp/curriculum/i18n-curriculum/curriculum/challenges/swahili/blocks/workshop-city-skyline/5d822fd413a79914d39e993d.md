...
Dodajte selektor za `:root` na vašem medijskom upitu (media query). Zatim ponovo definišite sve četiri promene od `--building-color` da koristite vrednost za `#000` tamo.

# --hints--

Trebalo bi dodati selektor `:root` na media query.
...
Trebalo bi dodati `--building-color1` sa vrednošću `#000`.
...
Treba da dodaš `--building-color2` sa vrednošću `#000`.
...
Trebalo bi da dodate `--building-color4` sa vrednošću `#000`.
