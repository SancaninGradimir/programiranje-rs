...
Vreme je da počnemo sa implementacijom funkcionalnosti za puštanje prikazanih pesama.

Definišite funkciju `playSong` koja prima jedan parametar koji će predstavljati jedinstveni identifikator pesme koju želite da pustite.
