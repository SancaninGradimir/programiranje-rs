...
U svaki vaš novi `a` element, dodajte element `i` i date im sledeće klase:

- Vaš prvi `i` element treba da ima klasu `fab fa-facebook-f`
- Vaš drugi `i` element treba da ima klasu `fab fa-twitter`
- Vaš treći `i` element treba da ima klasu `fab fa-instagram`
- Vaš četvrti `i` element treba da ima klasu `fab fa-linkedin-in`
- Vaš peti `i` element treba da ima klasu `fab fa-youtube`
