...
Biće vam potrebna varijabla za čuvanje tajnog koda dok ga dekodirate, pa uklonite `pass` i kreirajte varijablu nazvanu `secret_code` unutar funkcije i dodelite joj prazan string.
