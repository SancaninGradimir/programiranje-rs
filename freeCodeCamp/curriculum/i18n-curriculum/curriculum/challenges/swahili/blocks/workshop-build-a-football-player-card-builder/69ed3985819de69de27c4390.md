...
Sada ispravite `FootballPlayerCard` ili preskočite `defaultPlayer` za `PlayerCard` umesto nečega unutar linije.

# --hints--

Trebalo bi da imate `defaultPlayer` kao vrednost parametra `player` koji se prosleđuje za `PlayerCard`.
