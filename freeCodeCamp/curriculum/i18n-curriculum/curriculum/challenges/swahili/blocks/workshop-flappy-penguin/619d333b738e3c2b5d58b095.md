...
Na drugoj tački, rotiraj na `130deg`, i sačuvaj skaliranje levog ramena.

# --hints--

Trebalo bi da date tački za navigaciju `20%` u smeru `transform` od `rotate(130deg) scaleX(-1)`.
