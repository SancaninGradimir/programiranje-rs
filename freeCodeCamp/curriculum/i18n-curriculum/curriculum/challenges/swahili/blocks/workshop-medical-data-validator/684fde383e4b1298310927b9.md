...
Kvantifikatori se koriste u regularnim izrazima da bi se specificirao koliko puta se karakter može ponoviti. Na primer, karakter `+` odgovara prethodnom karakteru jedan ili više puta:
...
Stoga dodajte kvantifikator `+` vašem regex obrascu da biste pokupili jedan ili više cifara.
