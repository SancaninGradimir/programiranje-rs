...
Način za dodavanje poslednjeg elementa na meta, dodaj komentar koji kaže `move the nth disk from source to target`.

# --hints--

Treba da dodate pisani komentar pre `rods[target].append(rods[source].pop())`.
