...
Izraz `the head of` označava osobu koja vodi ili je rukovodilac određenog odeljenja ili grupe.
...
Ova reč započinje izraz koji označava osobu koja vodi.
...
Ova reč znači rukovodilac ili osoba koja vodi.
...
Ovaj predlog povezuje `head` sa odeljenjem ili oblašću kojom ta osoba rukovodi, u ovom slučaju `HR`.
