...
Treba da dodelite svojim prilagođenim radio dugmićima veličinu i oblik.

I dalje ciljajući `.contact-method-radio-btn`, postavite `width` na `20px`, `height` na `20px`, `border-radius` na `50%`, i `border` na `2px solid gray`.
