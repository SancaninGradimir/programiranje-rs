...
Trebalo bi da imate svojstvo `value_int` tipa `number`.
...
Trebalo bi da imate svojstvo `suit` tipa `string`.
...
Trebalo bi da imate svojstvo `type` tipa `string`.
...
Trebalo bi da imate svojstvo `img` tipa `string`.
...
Trebalo bi da imate svojstvo `meaning_up` tipa `string`.
...
Trebalo bi da imate svojstvo `meaning_rev` sa tipom `string`.
...
Trebalo bi da imate svojstvo `desc` tipa `string`.
