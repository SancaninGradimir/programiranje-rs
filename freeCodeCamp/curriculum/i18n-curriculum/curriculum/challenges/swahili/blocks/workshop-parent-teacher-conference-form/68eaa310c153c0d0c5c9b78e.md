...
Dobra praksa je dozvoliti korisnicima da dodaju dodatne napomene ili zabrinutosti.

Ispod vašeg trećeg `fieldset` elementa, dodajte novi `fieldset` element. Unutar njega, dodajte `legend` element sa tekstom `Additional Notes`.
