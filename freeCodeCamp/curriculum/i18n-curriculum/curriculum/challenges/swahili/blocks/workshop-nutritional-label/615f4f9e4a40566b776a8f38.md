...
Kreiraj novi `.large` selektor i dodeli mu svojstvo `height` postavljeno na `10px`. Takođe kreiraj `.large, .medium` selektor i postavi svojstvo `background-color` na `black`.
