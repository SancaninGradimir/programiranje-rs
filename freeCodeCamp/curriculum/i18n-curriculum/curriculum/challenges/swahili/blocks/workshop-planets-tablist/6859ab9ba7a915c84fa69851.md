...
Za drugi `tabpanel` element, dodajte atribut `id` sa vrednošću `"panel-saturn"` i atribut `aria-labelledby` sa vrednošću `"tab-saturn"`.

Za treći `tabpanel` element, dodajte atribut `id` sa vrednošću `"panel-mars"` i atribut `aria-labelledby` sa vrednošću `"tab-mars"`.
