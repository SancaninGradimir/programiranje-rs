...
Unutar tela vaše funkcije, promenite imena parametara `text` i `shift` u `message` i `offset`, odnosno.

# --hints--

Treba da promeniš sve imena `text` u `message`.
...
Treba da promeniš ime `shift` u `offset`.
