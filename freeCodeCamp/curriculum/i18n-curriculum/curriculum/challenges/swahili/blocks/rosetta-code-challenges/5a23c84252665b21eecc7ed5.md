...
Napiši funkciju koja prima `width` i `height` kao parametre i vraća broj početnih pozicija sa kojih je moguće izvršiti gore opisani zadatak.
...
`knightTour(6, 6)` treba da vrati broj.
