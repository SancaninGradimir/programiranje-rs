...
Trebalo bi da set `this.elements.subTitle.textContent` do `foundCard.meaning_up`.
...
Trebalo bi da set `this.elements.title.textContent` do `foundCard.name`.
...
Trebalo bi da pozovete funkciju `showElements` unutar `showFortune`.
...
Trebalo bi da prosledite `this.elements.fortuneDescription` as argument u `showElements`.
