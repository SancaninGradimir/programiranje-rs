...
title: 'Vežba 10: Zbir osnovnih brojeva'
challengeType: 1
forumTopicId: 301723
...
Suma prostih brojeva manjih od 10 je 2 + 3 + 5 + 7 = 17.

Pronađi zbir svih osnovnih brojeva ispod `n`.

# --hints--

`primeSummation(17)` Trebalo bi da vrati broj.

```js
assert.isNumber(primeSummation(17));
```

`primeSummation(17)` trebalo bi vratiti 41.

```js
assert.strictEqual(primeSummation(17), 41);
```

`primeSummation(2001)` trebalo bi da vrati 277050.

```js
assert.strictEqual(primeSummation(2001), 277050);
```

`primeSummation(140759)` trebalo bi vratiti 873608362.

```js
assert.strictEqual(primeSummation(140759), 873608362);
```

`primeSummation(2000000)` trebalo bi da vrati 142913828922.
