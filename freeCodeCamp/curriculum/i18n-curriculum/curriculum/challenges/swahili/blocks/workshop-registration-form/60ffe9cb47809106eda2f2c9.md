...
Na kraju, sa dugmetom za slanje, želite ga odvojiti od `fieldset` gore i prilagoditi njegovu širinu tako da nije manja od `300px`.

Promeni svojstvo `margin` ili spoji `1em` vrh i dno, dok su desna i leva ivica `auto`. Zatim postavi širinu kao što je opisano iznad.
...
Trebalo bi da koristiš postojeću karakteristiku `margin` za uključivanje `1em` gore i dole.
