...
Sada dodajte četiri opcije u padajući meni, `All`, `Woodwinds`, `Brass`, i `Percussion`, u ovom redosledu. Za svaku opciju, koristite mala slova opciju da biste specificirali atribut `id` i atribut `value`.
