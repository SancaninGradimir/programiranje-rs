...
U klasi `TVSeries`, kreirajte metod `__str__` koji vraća string sa sledećim formatom: `title (year) - S seasons, N episodes, duration min avg, director`, gde se `title`, `year`, `S`, `N`, `duration`, i `director` trebalo bi zameniti atributima `title`, `year`, `seasons`, `total_episodes`, `duration` i `director` po redosledu.
