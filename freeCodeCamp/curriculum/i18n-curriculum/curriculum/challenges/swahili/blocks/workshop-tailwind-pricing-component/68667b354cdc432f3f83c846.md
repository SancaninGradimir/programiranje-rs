...
Dodajte klase stavki `text-lg`, `font-semibold`, i `text-fuchsia-200` za funkciju `h2` paketa Premium.
...
Vaš element za `h2` treba da ima klasu objekata `text-fuchsia-200`.
