...
Poslednja pesma nosi naslov `Scratching the Surface`, umetnik je Quincy Larson, a fajl koji se koristi je `https://cdn.freecodecamp.org/curriculum/js-music-player/scratching-the-surface.mp3`.

Dodajte poslednju pesmu da biste kompletirali muzički plejer, prateći isti obrazac koji ste koristili za prve dve pesme.
