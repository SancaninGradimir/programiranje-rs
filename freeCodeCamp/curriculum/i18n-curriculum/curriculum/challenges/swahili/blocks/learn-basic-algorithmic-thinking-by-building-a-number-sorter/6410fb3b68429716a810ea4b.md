...
Algoritam Selection Sort-a zavisi od praćenja elementa sa najmanjom vrednošću u nizu podataka. Deklarišite varijablu `minIndex` i postavite joj vrednost `i` – ovo osigurava da, ako je vaša trenutna vrednost najmanja, ona će biti zamenjena samom sobom i neće se pomeriti. Biće vam potrebna mogućnost postavljanja nove vrednosti za `minIndex` dok iterirate kroz niz podataka.
