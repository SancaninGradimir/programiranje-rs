...
Sada napravite prostor, uklonite sve parametre dugmeta i `eventListener` koje ste kreirali za svako.

# --hints--

Parametar `happyBtn` ne bi trebalo da postoji.
...
Parametar `confusedBtn` ne bi trebalo da postoji.
...
Parametar `sadBtn` ne sme da postoji.
...
Parametar `lovingBtn` ne bi trebalo da postoji.
