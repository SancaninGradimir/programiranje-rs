...
Koristi atribut `border-radius` u kontroli `.two`, da postavi gornji-levi i donji-desni krug kao `8px`, a gornji-desni i donji-levi krug kao `10px`.
...
Vaše polje za `.two` treba da ima vrednost od `border-radius` na `8px 10px`.
