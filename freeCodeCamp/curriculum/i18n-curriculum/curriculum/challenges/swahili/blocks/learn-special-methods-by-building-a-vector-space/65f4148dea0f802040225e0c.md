...
Uklonite postojeće pozive za `print`. Zatim, kao što ste prvobitno uradili sa `v1`, objavite `v2` sa vrednošću vraćenom od `v2.norm()`.

# --hints--

Ne bi trebalo da imaš `print(v1)` i `print(v1.norm())` u svoj kod.
...
Trebalo bi da štampate `v2` i `v2.norm()`.
