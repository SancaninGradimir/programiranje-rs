...
Kreiraj još jednu klauzulu `except` koja hvata `MediaError as e`. Unutar bloka `except`, koristi se f-string za štampanje `Media Error:` praćen razmakom i porukom o grešci.
