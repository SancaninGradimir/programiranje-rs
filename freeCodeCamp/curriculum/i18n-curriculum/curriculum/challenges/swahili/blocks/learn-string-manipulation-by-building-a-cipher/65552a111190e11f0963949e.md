...
Izbriši glavni tekst od `pass`, i vrati `vigenere(message, key)` iz vaše nove funkcije.

# --hints--

Tvoja funkcija za `encrypt` treba da vrati `vigenere(message, key)`. Zapamtite da obrišete `pass`.
