...
`going to hold`, `going to need`, `monitor`, `do that after`, `require`, `implement`, i `are you going to`.
...
Ova upotreba se koristi tokom `Future Simple` i ukazuje na nešto što će biti potrebno u budućnosti.
...
Ovo pitanje se koristi kada `Future Simple` pita o planovima ili namerama.
...
Ovaj glagol znači staviti nešto u praksu ili sprovesti plan.
...
Ovaj glagol znači zahtevati ili učiniti nešto neophodnim/obaveznim.
...
Ovo korišćenje se koristi kada `Future Simple` da razgovara o planiranju ili zakazivanju događaja.
...
Ovaj glagol znači gledati ili pregledati nešto pažljivo.
...
Ova upotreba kombinuje glagol i afiks kako bi pokazala završavanje jedne radnje koja je praćena drugom.