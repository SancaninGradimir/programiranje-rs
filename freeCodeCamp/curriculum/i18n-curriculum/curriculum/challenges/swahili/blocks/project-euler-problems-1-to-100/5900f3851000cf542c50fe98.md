...
Broj F<sub>12</sub> je prvi Fibonačijev broj sa tri cifre.

Koji je indeks prvog Fibonačijevog broja koji ima `n` cifara?

# --hints--

`digitFibonacci(5)` treba da vrati broj.
