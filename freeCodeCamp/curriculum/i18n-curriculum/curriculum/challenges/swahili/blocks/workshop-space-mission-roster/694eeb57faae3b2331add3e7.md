...
U funkciji `getEVAReadyCrew`, pozovi `sortByPriorityDescending()` koristeći lokalni red podataka `eligible`, kako bi se sortirao pre nego što se vrati.

# --hints--

Treba da izvršite poziv ka `sortByPriorityDescending()` koristeći interni red podataka `eligible`.
