...
Upravo kao što je slučaj sa ugrađenim citatom, možete dodati i atribut `cite` na blok citat.

Evo primera bloka cita sa atributom `cite`:
...
Sada dodajte atribut `cite` na blok citat sa URL-om `https://www.freecodecamp.org/news/learn-to-code-book/`.
