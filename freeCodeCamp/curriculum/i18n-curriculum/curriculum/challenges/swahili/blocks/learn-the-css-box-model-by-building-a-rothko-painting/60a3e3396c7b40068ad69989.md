...
Promeni atribut `background-color` na `.three` u `#b20403`.

# --hints--

Trebalo bi da postaviš atribut `background-color` na `#b20403`.
...
Vaše polje za `.three` mora imati vrednost `background-color` od `#b20403`.
