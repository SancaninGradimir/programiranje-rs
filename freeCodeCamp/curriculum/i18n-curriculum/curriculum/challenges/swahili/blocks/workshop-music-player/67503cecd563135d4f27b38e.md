...
Sada je vreme da testiramo funkciju `playNextSong`. 

Dodajte `"click"` slušalicu događaja na element `nextButton`, a zatim prosledite `playNextSong` kao drugi argument vaše slušalice događaja. Ovo je funkcija koju će slušalica događaja izvršiti.

Testirajte svoju aplikaciju tako što ćete prvo kliknuti na dugme za reprodukciju, a zatim i na dugme "sledeći". Trebalo bi da vidite da sve radi kako je očekivano.
