...
Sada, dodaj klase `px-4`, `py-2`, `text-center`, na `font-semibold` jangkorni element.

# --hints--

Tvoj anker element treba da ima klasu `px-4`.
...
Vaš ankerski element mora da ima klasu `py-2`.
...
Tvoj anker element mora imati klasu `font-semibold`.
