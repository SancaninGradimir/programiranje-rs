...
Obezbedite tekst za `remainingCalories Calorie surplusOrDeficit` za vaš span element, koristeći vezivanje vrednosti da zamenite `remainingCalories` sa `surplusOrDeficit` za odgovarajuće parametre.

# --hints--

`span` mora imati tekst od `${remainingCalories} Calorie ${surplusOrDeficit}`.
