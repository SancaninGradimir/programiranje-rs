...
The `Game` class trebalo bi da ima `constructor`.
...
Vaš konstruktor bi trebalo da dodeli `this.elements`.
...
`singleCard` treba da bude set koristeći `getElement` sa `'.single_card'`.
