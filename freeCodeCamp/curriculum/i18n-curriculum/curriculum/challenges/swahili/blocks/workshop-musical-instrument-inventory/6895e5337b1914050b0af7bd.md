...
Sada, pozovite metodu `get_fact()` na instanci `instrument_1` i odštampajte rezultat.

Pošto `get_fact()` vraća string umesto da ga direktno odštampa, morate koristiti `print()` da prikažete vraćeni string.
