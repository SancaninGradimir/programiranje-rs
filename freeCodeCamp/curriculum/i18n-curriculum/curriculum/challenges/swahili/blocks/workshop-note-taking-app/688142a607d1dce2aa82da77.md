...
Bilo bi lepo videti izmenjene promene u konzoli.

Add a `console.log(currentContent);`. 

Da biste testirali svoje promene, pokušajte da izmenite napomenku i zatim da kliknete van te napomene. Sada bi trebalo da vidite izmenjenu napomenku u konzoli.
