...
Ažuriraj argument funkcije da bude `poems`, zatim kreiraj petlju `for` oko celog trenutnog sadržaja funkcije koja iterira preko `poems` i koristi `poem` kao varijablu petlje.
