...
Na kraju, u selektoru za medijski upit (media query) `:root`, ponovo definiši sve četiri parametra od `--window-color` da koriste `#777`. Kada završiš, promeni veličinu prozora i vidi kako se menja od dana do noći.

Kriterijumi se koriste posebno za boje, i tako ste ih koristili ovde. Ali mogu se dodeliti bilo koju vrednost i koristiti u bilo kom atributu. Tvoj projekat izgleda super!

# --hints--

Moraš dodati `--window-color1` sa vrednošću `#777`.
...
Morate dodati `--window-color4` sa vrednošću `#777`.
