...
Ovo će pokrenuti ceo program čim DOM bude preuzeto. Stoga, to je izvršna datoteka koja će biti poslata uskoro u događaju `DOMContentLoaded` koji će omogućiti programu da radi.

# --hints--

Trebalo bi da napraviš funkciju za `initializeApp`.
