...
Kao što je ranije pomenuto, kada korisnik izmeni belešku, a zatim klikne van beleške, treba da se prikaže poruka da je beleška sačuvana.

Da biste ovo postigli, postavite `statusEl.textContent` na niz (string) `"Note saved successfully!"`.

Sada kada to testirate, trebalo bi da vidite tu poruku prikazanu na ekranu.
