...
Promeni unapred određeno ime kluba iz `Santos FC` u `card-club` na `player.club`.

# --hints--

Trebalo bi da zameniš `Santos FC` koji je bio direktno postavljen sa `player.club` u `.card-club`.
