...
Konačno, dajte vašem `conversionTable` objekat tipa `teaspoon` sa svojstvom `cup` postavljeno na `1/48`, svojstvo `gram` postavljeno na `5`, i svojstvo `ounce` postavljeno na `0.167`.
