...
Sada dodaj `div` sa `className` od `form-group`. Unutar njega, dodaj `label` sa `className` od `label` i svojstvo atributa `htmlFor` od `name`. Ispod toga dodaj `input` sa `id` postavljeno na `name`, `className` od `input` i svojstvo atributa `type` od `text`.

# --hints--

Trebalo bi da imaš `div` sa `className` od `form-group`.
...
`form-group` vaše bi trebalo da ima `label` sa `className` od `label` i svojstvo elementa/karakteristike `htmlFor` od `name`.
...
`form-group` vaš treba da ima `input` sa `id` od `name`, `className` od `input`, i `type` od `text`.
