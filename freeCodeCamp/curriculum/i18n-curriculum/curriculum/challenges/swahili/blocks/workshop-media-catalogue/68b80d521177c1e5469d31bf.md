...
Sada kada je metoda `__init__` završena, kreiraj varijablu pod nazivom `series1` unutar bloka `try`. Dodeli joj instancu `TVSeries`, prosleđujući argumente po izboru. Zatim, ispiši `series1` na konzolu.
