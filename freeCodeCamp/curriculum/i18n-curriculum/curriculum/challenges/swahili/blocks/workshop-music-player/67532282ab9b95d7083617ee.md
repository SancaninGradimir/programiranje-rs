...
Unutar funkcije `playNextSong`, pozovite funkcije `setPlayerDisplay`, `highlightCurrentSong` i `setPlayButtonAccessibleText` kako biste pravilno ažurirali plejer kada se plejlista završi.
