...
Možete napisati citirani tekst direktno unutar elementa blok cita, kao što ste uradili u prvom `section` elementu. Alternativno, možete ga obaviti jednim ili više elemenata paragrafa. Ovo je korisno kada tekst ima više pasusa, ali želite da ih zadržite unutar istog elementa blok cita.

Evo primera sa dva pasusa:
...
U drugom odeljku, unutar postojećeg elementa blok cita, dodajte četiri `p` elementa sa sledećim tekstovima, po redu:
