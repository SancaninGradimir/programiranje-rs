...
Pošto ceo deo koji sadrži blog postove predstavlja glavni sadržaj stranice, treba ga pokriti elementom `main`. Ovo pomaže čitačima sa ekrana i drugim asistivnim tehnologijama da bolje razumeju strukturu stranice.
...
Tvoja komponenta za `main` mora imati sva tri elementa od `article` unutar sebe.
