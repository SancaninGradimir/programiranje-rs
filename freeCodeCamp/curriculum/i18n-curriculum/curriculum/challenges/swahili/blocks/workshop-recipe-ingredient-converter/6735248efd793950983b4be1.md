...
Dajte vašem `conversionTable` svojstvo `ounce`, i dodelite mu objekat sa svojstvom `cup` postavljeno na `0.125`, svojstvom `gram` postavljeno na `28.35`, i svojstvom `teaspoon` postavljeno na `6`.
