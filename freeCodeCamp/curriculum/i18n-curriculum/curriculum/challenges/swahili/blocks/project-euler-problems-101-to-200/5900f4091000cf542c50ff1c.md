...
title: 'Vežba 157: Rešavanje Diofantove jednačine'
challengeType: 1
forumTopicId: 301788
...
Razmotrite Diophantovog jednačinu $\frac{1}{a} + \frac{1}{b} = \frac{p}{{10}^n}$ gde su $a$, $b$, $p$, $n$ pozitivni ceo brojevi i $a \le b$.

Za $n = 1$, ova jednačina ima 20 rešenja, kao što je navedeno ispod:
...
Koliko rešenja ima ovaj izraz za $1 ≤ n ≤ 9?

# --hints--

`diophantineEquation()` treba da vrati `53490`.
