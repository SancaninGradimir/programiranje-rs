...
Ispod vašeg `.small-text` elementa, kreirajte novi `p` element sa tekstom `Calories`. Takođe ispod `.left-container` elementa, kreirajte novi `span` element sa tekstom `230`.
