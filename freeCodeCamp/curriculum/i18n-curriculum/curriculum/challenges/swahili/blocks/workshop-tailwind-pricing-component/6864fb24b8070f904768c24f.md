...
Sljedeći nivo cene je **Premium paket**.

Predajte klasu stavki `div`, `bg-gray-950`, `text-white`, `ring-2`, na `ring-fuchsia-500` za paket `p-8` premijum plana.

# --hints--

Vaš paket `div` za premijum plan treba da ima klasu objekata `bg-gray-950`.
...
Tvoj paket `div` za premium plan treba da ima klasu objekata `text-white`.
...
Tvoj paket `div` iz premium plana mora imati klasu objekata `ring-2`.
...
Vaš paket `div` za premium plan treba da ima klasu objekata `ring-fuchsia-500`.
...
Vaš paket `div` za premium plan mora imati klasu objekata `p-8`.
