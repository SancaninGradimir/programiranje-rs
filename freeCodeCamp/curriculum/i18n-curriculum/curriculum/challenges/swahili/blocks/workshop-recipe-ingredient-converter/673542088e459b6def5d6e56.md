...
Potrebna vam je funkcija koja zaista ažurira DOM. Deklarišite funkciju `updateResultsList`.

Da biste počeli, funkcija bi trebalo da obriše HTML iz elementa `resultList`.
