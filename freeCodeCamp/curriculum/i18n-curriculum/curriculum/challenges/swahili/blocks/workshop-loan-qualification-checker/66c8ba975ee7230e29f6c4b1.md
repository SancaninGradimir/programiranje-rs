...
Ako godišnji prihod i kreditni rejting kandidata padnu ispod `minIncomeForCar` i `minCreditScoreForCar`, onda se ne kvalifikuju za bilo koji kredit. Stoga, vrati string `"You don't qualify for any loans."`
