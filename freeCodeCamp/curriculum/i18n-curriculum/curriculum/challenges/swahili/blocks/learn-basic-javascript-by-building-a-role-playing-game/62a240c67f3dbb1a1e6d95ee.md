...
Koristite vikingo da postavite gornju ivicu na `30px`, donju ivicu na `0px`, i lijevu i desnu ivicu na `auto`.
...
Tvoj selektor za `#game` mora imati `margin-left` podešeno na `auto`.
