...
Deklariši funkciju `generate_password` i napiši sav svoj kod, osim linija `import`, unutar tela funkcije.

# --hints--

Trebalo bi da objavite funkciju sa imenom `generate_password`.
...
Izjava za import treba da ostane van funkcije.
...
Četiri deklaracije za varijable treba da se prebace unutar funkcije.
