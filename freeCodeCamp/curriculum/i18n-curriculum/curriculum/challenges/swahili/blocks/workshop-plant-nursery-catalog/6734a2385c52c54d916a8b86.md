...
Dodajte još par ključ-vrednost u svoj katalog. Koristite svoju varijablu `prettyPolly` kao ključ i napravite vrednost objekтом sa svojstvima `small`, `medium` i `large`, čije su vrednosti ponovo celobrojne.
