...
Po podrazumevanju, ostale kartice ne bi trebalo da budu izabrane. To možete učiniti dodavanjem atributa `aria-selected` drugom i trećem elementima `button` i postavljanjem njihovih vrednosti na `"false"`.
