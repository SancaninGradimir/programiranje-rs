...
Trenutno se deklarišu promene za `remainingCalories`, i postavite njegovu vrednost kao rezultat oduzimanja `consumedCalories` od `budgetCalories` i dodavanja `exerciseCalories`.

# --hints--

Vaša funkcija za `calculateCalories` mora imati izmene u vezi sa `remainingCalories`.
...
Treba da postaviš vrednost `budgetCalories - consumedCalories + exerciseCalories` za `remainingCalories`.
