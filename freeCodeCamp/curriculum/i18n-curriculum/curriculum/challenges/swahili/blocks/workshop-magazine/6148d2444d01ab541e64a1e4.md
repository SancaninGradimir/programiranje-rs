...
Kreiraj `.quote` selektor. Daj mu svojstvo `color` postavljeno na `#00beef`, svojstvo `font-size` postavljeno na `2.4rem`, i svojstvo `text-align` postavljeno na `center`.
