...
Sada ciljajte vaš `#piano` element sa `id` selektorom. Postavite njegovo `background-color` svojstvo na `#00471b`, `width` svojstvo na `992px` i `height` svojstvo na `290px`.
