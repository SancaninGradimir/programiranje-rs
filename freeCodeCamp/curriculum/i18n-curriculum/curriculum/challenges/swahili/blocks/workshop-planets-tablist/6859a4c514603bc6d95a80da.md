...
Sada je vreme da se tab paneli povežu sa svojim odgovarajućim tabovima. 

Za prvi element `tabpanel`, dodajte atribut `id` sa vrednošću `"panel-earth"` i atribut `aria-labelledby` sa vrednošću `"tab-earth"`.
