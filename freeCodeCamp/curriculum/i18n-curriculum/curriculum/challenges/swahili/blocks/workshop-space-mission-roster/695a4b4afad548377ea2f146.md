...
Koristi kola `for` za snimanje `name` svakog kosmičkog čoveka u bazu podataka `sorted`.

# --hints--

Trebalo bi da koristiš ciklus `for` za prolazak kroz niz podataka `sorted` i snimanje `name` svakog kosmičkog čoveka.
