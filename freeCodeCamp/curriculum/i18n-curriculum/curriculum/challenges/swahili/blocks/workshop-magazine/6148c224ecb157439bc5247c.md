...
Podrazumevane postavke za CSS Grid kreiraće dodatne redove po potrebi, za razliku od Flexbox-a. Dodajte selektoru `.social-icons` svojstvo `grid-template-columns`, postavljeno na `repeat(5, 1fr)`, kako biste poravnali ikone u jednom redu.
