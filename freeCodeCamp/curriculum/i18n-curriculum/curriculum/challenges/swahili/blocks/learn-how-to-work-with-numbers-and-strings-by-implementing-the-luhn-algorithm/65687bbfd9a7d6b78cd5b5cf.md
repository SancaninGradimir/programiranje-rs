...
Ponovi za sve pozitivne celobrojke, do broja N, i ispiši svaki na konzolu.

# --hints--

Trebalo bi da imaš ciklus od `for` preko `even_digits` unutar funkcije `verify_card_number`.
