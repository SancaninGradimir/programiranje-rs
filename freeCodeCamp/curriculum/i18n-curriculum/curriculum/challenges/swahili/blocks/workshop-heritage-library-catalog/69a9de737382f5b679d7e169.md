...
Da biste pronašli odgovarajuće autore, proverite svaki katalog unikatno.

Dodajte praznu petlju `for` unutar `findByAuthor` da biste iterirali preko `catalog`. Telo petlje ćete dodati u sledećem koraku.
