...
Izaberi pasus `#result` i sačuvaj u parametar nazvan `resultParagraph`. Koristićeš ovaj parametar za prikaz izabrane priče.

# --hints--

Treba da izaberete pasus od `#result` koristeći metodu `getElementById` i sačuvate ga u polje `resultParagraph`.
