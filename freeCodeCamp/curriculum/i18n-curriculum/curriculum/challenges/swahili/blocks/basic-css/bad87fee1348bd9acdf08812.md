...
CSS ima svojstvo `width` koje kontrolise sirinu elementa. Kao i kod fontova, koristicemo `px` (piksele) da odredimo sirinu slike.

Na primer, kada bismo zeleli da napravimo CSS klasu `larger-image` koja daje HTML elementima sirinu od 500 piksela, koristili bismo:
...
Napravite klasu pod nazivom `smaller-image` i upotrebite je da promenite velicinu slike na sirinu od samo 100 piksela.
...
Vasa slika treba da ima sirinu od 100 piksela.
