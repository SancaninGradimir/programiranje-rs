...
function Footer(): JSX.Element {
  ...
  // The freeCodeCamp-specific footer content (donation call-to-action,
  // trending guides, mobile app badges and the non-profit link block) is
  // temporarily hidden. These sections link to freeCodeCamp's external
  // platforms and describe a non-profit model that does not match our platform
  // yet. All the code, links and translations are kept intact below and the
  // sections can be restored by setting showLegacyFooterContent to true.
  const showLegacyFooterContent = false;
