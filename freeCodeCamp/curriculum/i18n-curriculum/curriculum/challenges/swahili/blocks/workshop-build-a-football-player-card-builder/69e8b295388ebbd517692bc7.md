...
Promeni ime igrača koje je postavljeno direktno u `PELE` unutar `card-name` i `player.name`.

# --hints--

Trebalo bi da promeniš `PELE` koji je umetnut direktno u `player.name` unutar `.card-name`.
