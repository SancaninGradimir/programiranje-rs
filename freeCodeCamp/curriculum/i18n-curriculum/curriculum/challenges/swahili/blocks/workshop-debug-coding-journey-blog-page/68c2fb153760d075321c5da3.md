...
Unapaswa kubadilisha kipengele cha `h1` chenye maandishi `My Journey Learning to Code` kuwa kipengele cha `h2`.
...
Unapaswa kubadilisha kipengele cha `h1` chenye maandishi `Accessibility Matters` kuwa kipengele cha `h2`.
