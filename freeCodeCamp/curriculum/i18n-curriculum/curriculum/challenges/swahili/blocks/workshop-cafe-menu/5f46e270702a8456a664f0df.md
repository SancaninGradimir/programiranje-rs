...
Da bi se uklonio vertikalni razmak između elementa od `h1` i teksta od `Est. 2020`, promijeni donju ivicu `h1` u `15px`.

# --hints--

Treba da postaviš vrednost `margin-bottom` kao `15px`.
...
Vaša karakteristika od `h1` mora imati svojstvo `margin-bottom` od `15px`.
