...
Da biste dovršili pripremu vaše svemirske misije, pozovite se na `printCrewSummary()` dok imate svoj list podataka za `updatedSquad`!

# --hints--

Trebaće ti da pozoveš svoju funkciju `printCrewSummary()` sa `updatedSquad`.
