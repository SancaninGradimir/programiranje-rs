...
Koristite `getElementById()` da dobijete `id` trenutno objavljenu pesmu, a zatim koristite ključeve za dodavanje prefiksa `song-`. Postavite njenu vrednost u konstantu `songToHighlight`.
