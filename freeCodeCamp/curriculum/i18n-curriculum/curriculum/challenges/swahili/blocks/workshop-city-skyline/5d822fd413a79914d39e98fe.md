...
Generišite i dodajte sledeće parametre za `.bb2a`:
...
Nakon dodavanja ovoga, videćete kako teška granica na elementu daje određen ugao gde se dve strane susreću. Koristićete donju granicu kao vrh zgrade.
...
Trebaš mu dati `.bb2a` `border-top` od `1vw solid #000`.
