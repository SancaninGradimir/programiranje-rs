...
Izaberite vaše elemente iz `td` za parametre `class` sa vrednošću `current`, i učinite font italik.
...
Vaš selektor za `td.current` mora imati svojstvo `font-style` postavljeno na `italic`.
