...
Dajte vašem `conversionTable` svojstvo `cup`, i dodelite mu objekat sa svojstvom `gram` postavljeno na `240`, svojstvom `ounce` postavljeno na `8.0`, i svojstvom `teaspoon` postavljeno na `48`.
