...
Primećujete kako tekst `8g` izgleda centrirano u predpogledu. Ugnjezdite element `span` koji sadrži tekst `Total Fat` zajedno sa tekstom `8g`, u dodatni element `span` za poravnanje.
