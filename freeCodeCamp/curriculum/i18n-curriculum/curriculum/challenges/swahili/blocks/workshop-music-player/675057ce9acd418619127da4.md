...
Sada, kreiraj funkciju pod nazivom `getPreviousSong`. Neka vrati pesmu koja se nalazi na `getCurrentSongIndex()` minus jedan u `userData.songs`, ili `undefined` ako je trenutna pesma prva u plejlisti.
