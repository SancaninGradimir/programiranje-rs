...
Da biste razlikovali različite vrste priča, moraćete da prosledite izabrani tip priče funkciji ``displayStory``.

Dodaj parametar nazvan `genre` za funkciju `displayStory`.

# --hints--

Trebalo bi da dodate parametar `genre` funkciji `displayStory`.
