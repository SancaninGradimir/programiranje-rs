...
Kreiraj selektor za `.calories-info h2` i ukloni sve vikinge.

# --hints--

Napravi generator za `.calories-info h2`.

```js
assert(new __helpers.CSSHelp(document).getStyle('.calories-info h2'));
```

Vaš selektor za `.calories-info h2` mora imati `margin` postavljen na `0`.
